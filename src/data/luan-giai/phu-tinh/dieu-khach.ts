...
có thể kết luận chính xác.`,
...

  {
    ...
    title: '⚠️ Điếu Khách + Chính Tinh ăn chơi + Sát tinh - cờ bạc nợ nần',
    sao: ['Điếu Khách'],
    ketHop: ['Kình Dương', 'Đà La', 'Hỏa Tinh', 'Linh Tinh', 'Địa Không', 'Địa Kiếp'],
    doUuTien: 65,
    tomTat: `⚠️ **Điếu Khách + chính tinh ăn chơi (Đồng / Tham / Âm / Liêm /
...
- Bố mẹ cũng dễ bị **LY TÁN**`,
...

  {
    ...
    title: '⚠️ Điếu Khách + Sát tinh tại Phụ Mẫu - bố mẹ ly tán',
    sao: ['Điếu Khách'],
    cung: ['Phụ Mẫu'],
    ketHop: ['Kình Dương', 'Đà La', 'Hỏa Tinh', 'Linh Tinh', 'Địa Không', 'Địa Kiếp'],
    doUuTien: 67,
    tomTat: `⚠️ **Điếu Khách + Sát tinh (Lục Sát) tại Phụ Mẫu:**
...
- Bố mẹ **LY TÁN** hoặc **buồn phiền, vướng vào tệ nạn**`,
...

  {
    ...
    title: '⚠️ Điếu Khách + Hóa Kỵ tại Phụ Mẫu - bố mẹ ly tán',
    sao: ['Điếu Khách'],
    cung: ['Phụ Mẫu'],
    ketHop: ['Hóa Kỵ'],
    doUuTien: 67,
    tomTat: `⚠️ **Điếu Khách + Hóa Kỵ tại Phụ Mẫu:**
- Mối quan hệ càng dễ **ĐỔ VỠ**
- Bố mẹ **LY TÁN** hoặc **buồn phiền, vướng vào tệ nạn**`,
  },

  {
    ...
    title: '⚠️ Điếu Khách + Thiên Hình tại Phụ Mẫu - bố mẹ ly tán',
    sao: ['Điếu Khách'],
    cung: ['Phụ Mẫu'],
    ketHop: ['Thiên Hình'],
    doUuTien: 67,
    tomTat: `⚠️ **Điếu Khách + Thiên Hình tại Phụ Mẫu:**
- Mối quan hệ càng dễ **ĐỔ VỠ**
- Bố mẹ **LY TÁN** hoặc **buồn phiền, vướng vào tệ nạn**`,
  },
...
- Hoặc phải đi xa để **TÌM KIẾM CƠ HỘI**`,
...

  {
    ...
    title: '⚠️ Điếu Khách + Đại Hao tại Phúc Đức - liên lụy họ hàng',
    sao: ['Điếu Khách'],
    cung: ['Phúc Đức'],
    ketHop: ['Đại Hao'],
    doUuTien: 70,
    tomTat: `⚠️ **Điếu Khách + Đại Hao tại Phúc Đức:** đương số dễ **BỊ LIÊN
LỤY** từ họ hàng (đời trước ăn chơi cờ bạc nợ nần).`,
  },

  {
    id: 'dieu-khach-tai-phuc-duc-tieu-hao',
    title: '⚠️ Điếu Khách + Tiểu Hao tại Phúc Đức - liên lụy họ hàng',
    sao: ['Điếu Khách'],
    cung: ['Phúc Đức'],
    ketHop: ['Tiểu Hao'],
    doUuTien: 70,
    tomTat: `⚠️ **Điếu Khách + Tiểu Hao tại Phúc Đức:** đương số dễ **BỊ LIÊN
LỤY** từ họ hàng (đời trước ăn chơi cờ bạc nợ nần).`,
  },

  {
    id: 'dieu-khach-tai-phuc-duc-thien-ma',
    title: '⚠️ Điếu Khách + Thiên Mã tại Phúc Đức - liên lụy họ hàng',
    sao: ['Điếu Khách'],
    cung: ['Phúc Đức'],
    ketHop: ['Thiên Mã'],
    doUuTien: 70,
    tomTat: `⚠️ **Điếu Khách + Thiên Mã tại Phúc Đức:** đương số dễ **BỊ LIÊN
LỤY** từ họ hàng (đời trước ăn chơi cờ bạc nợ nần).`,
  },

  {
    id: 'dieu-khach-tai-phuc-duc-da-la',
    title: '⚠️ Điếu Khách + Đà La tại Phúc Đức - liên lụy họ hàng',
    sao: ['Điếu Khách'],
    cung: ['Phúc Đức'],
    ketHop: ['Đà La'],
    doUuTien: 70,
    tomTat: `⚠️ **Điếu Khách + Đà La tại Phúc Đức:** đương số dễ **BỊ LIÊN LỤY**
từ họ hàng (đời trước ăn chơi cờ bạc nợ nần).`,
  },

  {
    id: 'dieu-khach-tai-phuc-duc-thien-rieu',
    title: '⚠️ Điếu Khách + Thiên Riêu tại Phúc Đức - liên lụy họ hàng',
    sao: ['Điếu Khách'],
    cung: ['Phúc Đức'],
    ketHop: ['Thiên Riêu'],
    doUuTien: 70,
    tomTat: `⚠️ **Điếu Khách + Thiên Riêu tại Phúc Đức:** đương số dễ **BỊ LIÊN
LỤY** từ họ hàng (đời trước ăn chơi cờ bạc nợ nần).`,
  },

  {
    id: 'dieu-khach-tai-phuc-duc-hoa-ky',
    title: '⚠️ Điếu Khách + Hóa Kỵ tại Phúc Đức - liên lụy họ hàng',
    sao: ['Điếu Khách'],
    cung: ['Phúc Đức'],
    ketHop: ['Hóa Kỵ'],
    doUuTien: 70,
    tomTat: `⚠️ **Điếu Khách + Hóa Kỵ tại Phúc Đức:** đương số dễ **BỊ LIÊN LỤY**
từ họ hàng (đời trước ăn chơi cờ bạc nợ nần).`,
  },

  {
    id: 'dieu-khach-tai-phuc-duc-dia-kiep',
    title: '⚠️ Điếu Khách + Địa Kiếp tại Phúc Đức - liên lụy họ hàng',
    sao: ['Điếu Khách'],
    cung: ['Phúc Đức'],
    ketHop: ['Địa Kiếp'],
    doUuTien: 70,
    tomTat: `⚠️ **Điếu Khách + Địa Kiếp tại Phúc Đức:** đương số dễ **BỊ LIÊN
LỤY** từ họ hàng (đời trước ăn chơi cờ bạc nợ nần).`,
  },
...
- **SA ĐÀ vào THÓI XẤU**`,
...

  {
    ...
    title: '⚠️ Điếu Khách + Đại Hao tại Nô Bộc - bạn bè mờ ám',
    sao: ['Điếu Khách'],
    cung: ['Nô Bộc'],
    ketHop: ['Đại Hao'],
    doUuTien: 67,
    tomTat: `⚠️ **Điếu Khách + Đại Hao tại Nô Bộc:** bạn bè **dây dưa, liên đới,
mờ ám** — đương số dễ **BỊ KÉO VÀO** thói hư tật xấu.`,
  },

  {
    id: 'dieu-khach-tai-no-boc-tieu-hao',
    title: '⚠️ Điếu Khách + Tiểu Hao tại Nô Bộc - bạn bè mờ ám',
    sao: ['Điếu Khách'],
    cung: ['Nô Bộc'],
    ketHop: ['Tiểu Hao'],
    doUuTien: 67,
    tomTat: `⚠️ **Điếu Khách + Tiểu Hao tại Nô Bộc:** bạn bè **dây dưa, liên
đới, mờ ám** — đương số dễ **BỊ KÉO VÀO** thói hư tật xấu.`,
  },

  {
    id: 'dieu-khach-tai-no-boc-dia-kiep',
    title: '⚠️ Điếu Khách + Địa Kiếp tại Nô Bộc - bạn bè mờ ám',
    sao: ['Điếu Khách'],
    cung: ['Nô Bộc'],
    ketHop: ['Địa Kiếp'],
    doUuTien: 67,
    tomTat: `⚠️ **Điếu Khách + Địa Kiếp tại Nô Bộc:** bạn bè **dây dưa, liên
đới, mờ ám** — đương số dễ **BỊ KÉO VÀO** thói hư tật xấu.`,
  },

  {
    id: 'dieu-khach-tai-no-boc-da-la',
    title: '⚠️ Điếu Khách + Đà La tại Nô Bộc - bạn bè mờ ám',
    sao: ['Điếu Khách'],
    cung: ['Nô Bộc'],
    ketHop: ['Đà La'],
    doUuTien: 67,
    tomTat: `⚠️ **Điếu Khách + Đà La tại Nô Bộc:** bạn bè **dây dưa, liên đới,
mờ ám** — đương số dễ **BỊ KÉO VÀO** thói hư tật xấu.`,
  },

  {
    id: 'dieu-khach-tai-no-boc-thien-rieu',
    title: '⚠️ Điếu Khách + Thiên Riêu tại Nô Bộc - bạn bè mờ ám',
    sao: ['Điếu Khách'],
    cung: ['Nô Bộc'],
    ketHop: ['Thiên Riêu'],
    doUuTien: 67,
    tomTat: `⚠️ **Điếu Khách + Thiên Riêu tại Nô Bộc:** bạn bè **dây dưa, liên
đới, mờ ám** — đương số dễ **BỊ KÉO VÀO** thói hư tật xấu.`,
  },

  {
    id: 'dieu-khach-tai-no-boc-hoa-ky',
    title: '⚠️ Điếu Khách + Hóa Kỵ tại Nô Bộc - bạn bè mờ ám',
    sao: ['Điếu Khách'],
    cung: ['Nô Bộc'],
    ketHop: ['Hóa Kỵ'],
    doUuTien: 67,
    tomTat: `⚠️ **Điếu Khách + Hóa Kỵ tại Nô Bộc:** bạn bè **dây dưa, liên đới,
mờ ám** — đương số dễ **BỊ KÉO VÀO** thói hư tật xấu.`,
  },
...
**LÀM CHỦ**.`,
...

  {
    ...
    title: '⚠️ Điếu Khách + Địa Kiếp tại Tài Bạch - cờ bạc xa hoa',
    sao: ['Điếu Khách'],
    cung: ['Tài Bạch'],
    ketHop: ['Địa Kiếp'],
    doUuTien: 70,
    tomTat: `⚠️ **Điếu Khách + Địa Kiếp tại Tài Bạch:**
- Dễ **ĐAM MÊ CỜ BẠC**
- Hoặc dùng nhiều tiền để **PHỤC VỤ NHU CẦU XA HOA của bản thân**`,
...

  {
    ...
    title: '⚠️ Điếu Khách + Phục Binh tại Tài Bạch - cờ bạc xa hoa',
    sao: ['Điếu Khách'],
    cung: ['Tài Bạch'],
    ketHop: ['Phục Binh'],
    doUuTien: 70,
    tomTat: `⚠️ **Điếu Khách + Phục Binh tại Tài Bạch:**
- Dễ **ĐAM MÊ CỜ BẠC**
- Hoặc dùng nhiều tiền để **PHỤC VỤ NHU CẦU XA HOA của bản thân**`,
  },

  {
    ...
    title: '⚠️ Điếu Khách + Đại Hao tại Tài Bạch - cờ bạc xa hoa',
    sao: ['Điếu Khách'],
    cung: ['Tài Bạch'],
    ketHop: ['Đại Hao'],
    doUuTien: 70,
    tomTat: `⚠️ **Điếu Khách + Đại Hao tại Tài Bạch:**
- Dễ **ĐAM MÊ CỜ BẠC**
- Hoặc dùng nhiều tiền để **PHỤC VỤ NHU CẦU XA HOA của bản thân**`,
  },

  {
    ...
    title: '⚠️ Điếu Khách + Tiểu Hao tại Tài Bạch - cờ bạc xa hoa',
    sao: ['Điếu Khách'],
    cung: ['Tài Bạch'],
    ketHop: ['Tiểu Hao'],
    doUuTien: 70,
    tomTat: `⚠️ **Điếu Khách + Tiểu Hao tại Tài Bạch:**
- Dễ **ĐAM MÊ CỜ BẠC**
- Hoặc dùng nhiều tiền để **PHỤC VỤ NHU CẦU XA HOA của bản thân**`,
  },

  {
    ...
    title: '⚠️ Điếu Khách + Đà La tại Tài Bạch - cờ bạc xa hoa',
    sao: ['Điếu Khách'],
    cung: ['Tài Bạch'],
    ketHop: ['Đà La'],
    doUuTien: 70,
    tomTat: `⚠️ **Điếu Khách + Đà La tại Tài Bạch:**
- Dễ **ĐAM MÊ CỜ BẠC**
- Hoặc dùng nhiều tiền để **PHỤC VỤ NHU CẦU XA HOA của bản thân**`,
  },

  {
    ...
    title: '⚠️ Điếu Khách + Kình Dương tại Tài Bạch - cờ bạc xa hoa',
    sao: ['Điếu Khách'],
    cung: ['Tài Bạch'],
    ketHop: ['Kình Dương'],
    doUuTien: 70,
    tomTat: `⚠️ **Điếu Khách + Kình Dương tại Tài Bạch:**
- Dễ **ĐAM MÊ CỜ BẠC**
- Hoặc dùng nhiều tiền để **PHỤC VỤ NHU CẦU XA HOA của bản thân**`,
  },
...
- Mối quan hệ thiếu **THÂN MẬT**`,
...

  {
    ...
    title: '⚠️ Điếu Khách + Sát tinh tại Tử Tức - con khó nuôi',
    sao: ['Điếu Khách'],
    cung: ['Tử Tức'],
    ketHop: ['Kình Dương', 'Đà La', 'Hỏa Tinh', 'Linh Tinh', 'Địa Không', 'Địa Kiếp'],
    doUuTien: 67,
    tomTat: `⚠️ **Điếu Khách + Sát tinh (Lục Sát) tại Tử Tức:**
...
- Có **TÀI ĂN NÓI**, **HAM VUI HAM CHƠI**`,
...

  {
    ...
    title: '⚠️ Điếu Khách + Địa Kiếp tại Phu Thê - bị đào tiền',
    sao: ['Điếu Khách'],
    cung: ['Phu Thê'],
    ketHop: ['Địa Kiếp'],
    doUuTien: 70,
    tomTat: `⚠️ **Điếu Khách + Địa Kiếp tại Phu Thê** (kèm Lộc ở vị trí bổ trợ):
sẽ thành tình huống người bạn đời nhìn mình như "**MỎ VÀNG**" → bị đào tiền.`,
  },

  {
    id: 'dieu-khach-tai-phu-the-da-la',
    title: '⚠️ Điếu Khách + Đà La tại Phu Thê - bị đào tiền',
    sao: ['Điếu Khách'],
    cung: ['Phu Thê'],
    ketHop: ['Đà La'],
    doUuTien: 70,
    tomTat: `⚠️ **Điếu Khách + Đà La tại Phu Thê** (kèm Lộc ở vị trí bổ trợ):
sẽ thành tình huống người bạn đời nhìn mình như "**MỎ VÀNG**" → bị đào tiền.`,
  },

  {
    id: 'dieu-khach-tai-phu-the-thien-rieu',
    title: '⚠️ Điếu Khách + Thiên Riêu tại Phu Thê - bị đào tiền',
    sao: ['Điếu Khách'],
    cung: ['Phu Thê'],
    ketHop: ['Thiên Riêu'],
    doUuTien: 70,
    tomTat: `⚠️ **Điếu Khách + Thiên Riêu tại Phu Thê** (kèm Lộc ở vị trí bổ
...
tiền.`,
...

  {
    ...
    title: '⚠️ Điếu Khách + Hóa Kỵ tại Phu Thê - bị đào tiền',
    sao: ['Điếu Khách'],
    cung: ['Phu Thê'],
    ketHop: ['Hóa Kỵ'],
    doUuTien: 70,
    tomTat: `⚠️ **Điếu Khách + Hóa Kỵ tại Phu Thê** (kèm Lộc ở vị trí bổ trợ):
sẽ thành tình huống người bạn đời nhìn mình như "**MỎ VÀNG**" → bị đào tiền.`,
  },
...
- Mối quan hệ **KÉM THÂN THIẾT**, nhiều sự **KHÁCH KHÍ, XÃ GIAO**`,
...

  {
    ...
    title: '⚠️ Điếu Khách + Đại Hao tại Huynh Đệ - kéo vào thói hư',
    sao: ['Điếu Khách'],
    cung: ['Huynh Đệ'],
    ketHop: ['Đại Hao'],
    doUuTien: 65,
    tomTat: `⚠️ **Điếu Khách + Đại Hao tại Huynh Đệ:** anh em chị em trong nhà
có xu hướng **KÉO ĐƯƠNG SỐ vào THÓI HƯ TẬT XẤU**.`,
  },

  {
    id: 'dieu-khach-tai-huynh-de-tieu-hao',
    title: '⚠️ Điếu Khách + Tiểu Hao tại Huynh Đệ - kéo vào thói hư',
    sao: ['Điếu Khách'],
    cung: ['Huynh Đệ'],
    ketHop: ['Tiểu Hao'],
    doUuTien: 65,
    tomTat: `⚠️ **Điếu Khách + Tiểu Hao tại Huynh Đệ:** anh em chị em trong nhà
có xu hướng **KÉO ĐƯƠNG SỐ vào THÓI HƯ TẬT XẤU**.`,
  },

  {
    id: 'dieu-khach-tai-huynh-de-dia-kiep',
    title: '⚠️ Điếu Khách + Địa Kiếp tại Huynh Đệ - kéo vào thói hư',
    sao: ['Điếu Khách'],
    cung: ['Huynh Đệ'],
    ketHop: ['Địa Kiếp'],
    doUuTien: 65,
    tomTat: `⚠️ **Điếu Khách + Địa Kiếp tại Huynh Đệ:** anh em chị em trong nhà
có xu hướng **KÉO ĐƯƠNG SỐ vào THÓI HƯ TẬT XẤU**.`,
  },

  {
    id: 'dieu-khach-tai-huynh-de-da-la',
    title: '⚠️ Điếu Khách + Đà La tại Huynh Đệ - kéo vào thói hư',
    sao: ['Điếu Khách'],
    cung: ['Huynh Đệ'],
    ketHop: ['Đà La'],
    doUuTien: 65,
    tomTat: `⚠️ **Điếu Khách + Đà La tại Huynh Đệ:** anh em chị em trong nhà có
xu hướng **KÉO ĐƯƠNG SỐ vào THÓI HƯ TẬT XẤU**.`,
  },

  {
    id: 'dieu-khach-tai-huynh-de-thien-rieu',
    title: '⚠️ Điếu Khách + Thiên Riêu tại Huynh Đệ - kéo vào thói hư',
    sao: ['Điếu Khách'],
    cung: ['Huynh Đệ'],
    ketHop: ['Thiên Riêu'],
    doUuTien: 65,
    tomTat: `⚠️ **Điếu Khách + Thiên Riêu tại Huynh Đệ:** anh em chị em trong
nhà có xu hướng **KÉO ĐƯƠNG SỐ vào THÓI HƯ TẬT XẤU**.`,
  },

  {
    id: 'dieu-khach-tai-huynh-de-hoa-ky',
    title: '⚠️ Điếu Khách + Hóa Kỵ tại Huynh Đệ - kéo vào thói hư',
    sao: ['Điếu Khách'],
    cung: ['Huynh Đệ'],
    ketHop: ['Hóa Kỵ'],
    doUuTien: 65,
    tomTat: `⚠️ **Điếu Khách + Hóa Kỵ tại Huynh Đệ:** anh em chị em trong nhà
có xu hướng **KÉO ĐƯƠNG SỐ vào THÓI HƯ TẬT XẤU**.`,
  },
...
→ Cách cục **CỰC NGUY HIỂM** — cần đặc biệt thận trọng vào hạn.`,
...

  {
    ...
    title: '⚠️ Điếu Khách + Đà La + Địa Kiếp + Tuần Không - càng kẹt vòng lặp',
    sao: ['Điếu Khách'],
    ketHop: ['Đà La', 'Địa Kiếp', 'Tuần'],
    doUuTien: 60,
    tomTat: `⚠️ **Điếu Khách + Đà La + Địa Kiếp + Tuần (Tuần Không):** càng kẹt
