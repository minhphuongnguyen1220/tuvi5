...
**Cảnh báo:** Đế Vượng KHÔNG ƯA đóng cung **TẬT ÁCH** — vì sẽ khuếch
...
- **KHÁ GIẢ**`,
...

  {
    ...
    doUuTien: 65,
    tomTat: `**Đế Vượng + Kình Dương + Đà La + Địa Không + Địa Kiếp + Linh Tinh + Hỏa
...
**Cảnh báo:** cần giữ **TỈNH TÁO VÀ ĐẠO ĐỨC NGHỀ NGHIỆP** để tránh rủi
ro không đáng có.`,
  },
...
điểm.`,
...

  {
    ...
    cung: ['Tật Ách'],
    doUuTien: 78,
    tomTat: `**Đế Vượng tại Tật Ách** — vị trí **KHÔNG ƯA** của Đế Vượng.

**Đặc trưng:**
- **NHIỀU BỆNH TẬT** trong người
- Đế Vượng khuếch đại số lượng: bệnh dồn dập

**Sát tinh hội** (Kình Đà, Không Kiếp, Linh Hỏa):
