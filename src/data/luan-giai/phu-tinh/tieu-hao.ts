...
**Lưu ý:** Song Hao tuy là bại tinh nhưng khi đắc địa **CẦN có chính tinh
...
có** — thông minh, ham học, **muốn trông xa biết rộng**.`,
...

  {
    ...
    doUuTien: 70,
    tomTat: `**Tiểu Hao Hãm địa + Hóa Kỵ / Phá Quân / sát tinh tại Mệnh:** tiền tài
hao tán: túng thiếu, **thất thường**.`,
...

  {
    ...
    doUuTien: 70,
    tomTat: `**Tiểu Hao Hãm + sát bại tinh tại Mệnh:** dễ có **đam mê** (cờ bạc,
...
phải **thay đổi nơi ăn chốn ở, nghề nghiệp**.`,
...

  {
    ...
    trangThai: ['Hãm'],
    doUuTien: 65,
    tomTat: `**Tiểu Hao Hãm địa tại Phụ Mẫu:** cha mẹ **gầy gò, vất vả**, đồng tiền
**tán tụ thất thường**.`,
  },
...
thể được cha mẹ tạo điều kiện đầu tư hoặc giúp đỡ ngược lại.`,
...

  {
    ...
    doUuTien: 65,
    tomTat: `**Tiểu Hao tại Phụ Mẫu + Thiên Hình / Thiên Việt:** cha mẹ **khó tính,
...
suối, dòng sông** chạy qua. Tùy đắc/hãm để xác định tốt xấu.`,
...

  {
    ...
    trangThai: ['Hãm'],
    doUuTien: 70,
    tomTat: `**Tiểu Hao Hãm địa cư Phúc Đức:** **ĐIỂM KỴ** — làm **giảm phúc phần,
may mắn** tổ tiên để lại.

Trong dòng họ **nhiều người nghèo túng, bần hàn**, phải **tha hương lập
nghiệp** — "tha hương cầu thực", mỗi người một nơi.`,
...

  {
    ...
    ketHop: ['Địa Kiếp'],
    doUuTien: 67,
    tomTat: `**Tiểu Hao tại Phúc Đức + Địa Kiếp:** đương số **cô độc, vất vả** hoặc
...
**nhà 2 mặt tiền**.`,
...

  {
    ...
    trangThai: ['Hãm'],
    doUuTien: 73,
    tomTat: `**Tiểu Hao Hãm địa cư Điền Trạch:** **TÁN nhiều TỤ ít**, khó giàu có. Dù
có cũng phải **bán** hoặc **hao tốn tài sản**.`,
...

  {
    ...
    doUuTien: 70,
    tomTat: `**Tiểu Hao Hãm địa + Không Kiếp tại Điền Trạch:** **TÁN nhiều TỤ ít**,
...
vào liên tục.`,
...

  {
    ...
    ketHop: ['Địa Kiếp'],
    doUuTien: 70,
    tomTat: `**Tiểu Hao tại Điền Trạch + Địa Kiếp:** "thêm dầu vào lửa": dễ mắc
...
quy mô lớn.`,
...

  {
    ...
    trangThai: ['Hãm'],
    doUuTien: 70,
    tomTat: `**Tiểu Hao Hãm địa cư Quan Lộc:** cản trở **công danh, sự nghiệp** —
...
THỦ một phương bên ngoài** (quyền lực ở phương xa).`,
  ...
  // ============================================================
  {
    ...
    cung: ['Nô Bộc'],
    doUuTien: 68,
    tomTat: `**Tiểu Hao cư Nô Bộc:** **khó thuê mướn người làm**, bị **tôi tớ trộm
...
**lợi trở lại**.`,
...

  {
    ...
    trangThai: ['Hãm'],
    doUuTien: 65,
    tomTat: `**Tiểu Hao Hãm địa tại Nô Bộc:** đầu tư cho bạn bè, các mối quan hệ
**thất thoát, hao tán** không hợp lý.`,
...

  {
    ...
    doUuTien: 65,
    tomTat: `**Tiểu Hao tại Nô Bộc + Quan Phù / Quan Phủ:** bị **kiện cáo, tranh
tụng** làm hao tán.`,
  },

  {
    ...
    doUuTien: 65,
    tomTat: `**Tiểu Hao tại Nô Bộc + Sát Phá Tham + Thiên Hình:** **bị cướp**.`,
  },
  ...
  // ============================================================
  {
    ...
    cung: ['Thiên Di'],
    doUuTien: 68,
    tomTat: `**Tiểu Hao cư Thiên Di:** ra ngoài hay gặp **chuyện phải tốn tiền,
...
**Bệnh thường gặp:** liên quan **bộ phận tiêu hóa, đường ruột, gan, dạ dày**.`,
...

  {
    ...
    trangThai: ['Đắc'],
    doUuTien: 70,
    tomTat: `**NGOẠI LỆ — Tiểu Hao Đắc địa tại Tật Ách:** không tốt — gây **TÍCH TỤ,
ứ đọng** tai họa, bệnh tật: bệnh **bùng phát DỮ DỘI, dồn dập**.`,
...

  {
    ...
    doUuTien: 70,
    tomTat: `**Tiểu Hao tại Tật Ách + Phá Quân / Song Hao / Thất Sát / Mộc Dục / Hóa
Kỵ:** thường bị **UNG NHỌT, UNG THƯ phải mổ xẻ**.`,
...

  {
    ...
    doUuTien: 70,
    tomTat: `**Tiểu Hao tại Tật Ách + Kình Đà / Không Kiếp / Hóa Kỵ:** vì đam mê thứ
...
trạng thái đắc / hãm.`,
...

  {
    ...
    trangThai: ['Hãm'],
    doUuTien: 78,
    tomTat: `**Tiểu Hao Hãm địa rất kỵ tại Tài Bạch / Điền Trạch / Phúc Đức** — 3
cung Tài/Điền/Phúc nếu có Tiểu Hao Hãm là **rất xấu**.`,
...

  {
    ...
    trangThai: ['Hãm'],
    doUuTien: 78,
    tomTat: `**Tiểu Hao Hãm địa cư Tài Bạch:** **TÁN TÀI, HAO TÀI**, **nghèo túng**,
có tiền phải **tiêu luôn**, **khó tích trữ**.`,
...

  {
    ...
    doUuTien: 73,
    tomTat: `**Tiểu Hao tại Tài Bạch + Đào / Hồng:** tốn tiền vì **nhân tình, làm
đẹp**.`,
  },

  {
    ...
    doUuTien: 73,
    tomTat: `**Tiểu Hao tại Tài Bạch + Phá Quân / Tuyệt:** dễ **PHÁ SẢN**.`,
  },

  {
    ...
    doUuTien: 73,
    tomTat: `**Tiểu Hao tại Tài Bạch + Kình / Đà / Không / Kiếp:** cũng **bị PHÁ
SẢN**.`,
  },
...
sớm** — "chim non rời tổ". Con cái **làm hao tán tiền của cha mẹ**.`,
...

  {
    ...
    trangThai: ['Hãm'],
    doUuTien: 68,
    tomTat: `**Tiểu Hao Hãm địa cư Tử Tức:** **giảm số lượng con cái** — **sinh
...
con cái **thông minh, ham học**.`,
  ...
  // ============================================================
  {
    ...
    cung: ['Phu Thê'],
    doUuTien: 70,
    tomTat: `**Tiểu Hao cư Phu Thê:** **không ưa** — hội thêm **sát bại tinh** làm
...
Vợ chồng dễ **xa quê cách quán**.`,
...

  {
    ...
    trangThai: ['Hãm'],
    doUuTien: 73,
    tomTat: `**Tiểu Hao Hãm địa tại Phu Thê:** người hôn phối **HOANG TÀN, phá của**,
gây **chia ly**.`,
  },

  {
    ...
    ketHop: ['Đào Hoa', 'Hồng Loan'],
    doUuTien: 70,
    tomTat: `**Tiểu Hao Đắc địa + Đào Hồng thủ Mệnh tại Phu Thê:** dễ **NHIỀU VỢ,
thê thiếp**, "**mỗi ngày ở với một bà**".`,
...

  {
    ...
    doUuTien: 70,
    tomTat: `**Tiểu Hao tại Phu Thê + Đà La / Thiên Hình / Thiên Riêu:** người hôn
...
duyên kinh doanh.`,
  ...
  // ============================================================
  {
    ...
    cung: ['Huynh Đệ'],
    doUuTien: 68,
    tomTat: `**Tiểu Hao cư Huynh Đệ:** **GIẢM số lượng anh chị em**.
...
tán**, gây **tổn thất tài sản chung**.`,
...

  {
    ...
    ketHop: ['Kình Dương', 'Đà La', 'Hỏa Tinh', 'Linh Tinh', 'Địa Không', 'Địa Kiếp'],
    doUuTien: 65,
    tomTat: `**Tiểu Hao tại Huynh Đệ + Sát bại tinh:** dễ có người **chết trẻ**,
...
chi càng có lại.`,
  ...
  // ============================================================
  {
    ...
    ketHop: ['Tuyệt'],
    doUuTien: 60,
    tomTat: `**Tiểu Hao + Tuyệt đồng cung:** người **XẢO QUYỆT**.
...
**sự tin tưởng** của người xung quanh, **"một lần bất tín, vạn lần bất tin"**.`,
...

  {
    ...
    ketHop: ['Tuyệt'],
    doUuTien: 65,
    tomTat: `**Tiểu Hao + Tuyệt tại Mệnh VCD** (Vô Chính Diệu): càng **xảo trá**,
**rất KEO KIỆT, tham lận**.`,
  ...
  // ============================================================
  {
    ...
    ketHop: ['Đào Hoa', 'Hồng Loan'],
    doUuTien: 60,
    tomTat: `**Tiểu Hao / Đại Hao + Đào Hoa / Hồng Loan:** **TỐN TIỀN CHO NHÂN
...
- Tiềm ẩn nguy cơ **đổ vỡ hôn nhân**, **mất hòa khí gia đình**`,
  ...
  // ============================================================
  {
    ...
    doUuTien: 62,
    tomTat: `**Tiểu Hao + Thiên Hình + Không Kiếp + Hỏa Linh:** rơi vào **NGHIỆN
...
- Tốn tiền của + tổn hại **danh dự, uy tín, mối quan hệ**.`,
  ...
  // ============================================================
  {
    ...
    doUuTien: 60,
    tomTat: `**Tiểu Hao + Phá Quân / Tuyệt:** dễ **PHÁ SẢN**.

**Tiểu Hao + Kình / Đà / Không / Kiếp:** cũng **PHÁ SẢN**.
...
- Tâm lý "**được ăn cả, ngã về không**": đầu tư quá mức, chơi lớn: mất hết.`,
...

  {
    ...
    ketHop: ['Phá Quân', 'Tuyệt', 'Kình Dương', 'Đà La', 'Địa Không', 'Địa Kiếp'],
    doUuTien: 65,
    tomTat: `**Tiểu Hao + sát phá tinh tại Mệnh / Tài Bạch:** đặc biệt nguy hiểm —
nguy cơ **PHÁ SẢN** rất cao.`,
  ...
  // ============================================================
  {
    ...
    ketHop: ['Quan Phù', 'Quan Phủ'],
    doUuTien: 60,
    tomTat: `**Song Hao + Quan Phù hoặc Quan Phủ:** bị **KIỆN CÁO, TRANH TỤNG**
làm **hao tán**.
...
- Vướng vào kiện tụng tài chính, mất tiền vì pháp lý.`,
...

  {
    ...
    doUuTien: 55,
    tomTat: `**Song Hao + Thất Sát + Thiên Hình:** **bị CƯỚP** — thậm chí bị
cướp tài sản.`,
  },

  {
    ...
    doUuTien: 55,
    tomTat: `**Song Hao + Phá Quân + Thiên Hình:** **bị CƯỚP** — thậm chí bị
cướp tài sản.`,
  },

  {
    ...
    doUuTien: 55,
    tomTat: `**Song Hao + Tham Lang + Thiên Hình:** **bị CƯỚP** — thậm chí bị
cướp tài sản.`,
  },
  ...
  // ============================================================
  {
    ...
    sao: ['Tiểu Hao'],
    doUuTien: 50,
    tomTat: `**Hạn có Tiểu Hao:** dịp **HAO TÀI TỐN CỦA**:
