...
⚠️ **Đặc tính TÂM LINH:** Tấu Thư + **Tam Thai + Bát Tọa + Hỏa Linh + Kình
...
khi hoạt động xã hội.`,
  ...
  // ============================================================
  {
    ...
    cung: ['Tật Ách'],
    doUuTien: 75,
    tomTat: `⚠️ **Tấu Thư cư Tật:** **KHÔNG PHẢI bệnh thể chất** mà thiên về
...
- **Cưới hỏi** thuận lợi`,
  ...
  // ============================================================
  {
    ...
    doUuTien: 60,
    tomTat: `⚠️ **Tấu Thư + Kình Đà + Không Kiếp + Hỏa Linh + Quan Phủ:** năng
...
⚠️ **Đặc biệt nguy hiểm:** báo hiệu **đổ vỡ HÔN NHÂN** vì mâu thuẫn **không
thể hòa giải**.`,
  },
