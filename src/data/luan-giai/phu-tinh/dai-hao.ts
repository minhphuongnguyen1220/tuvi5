...
⚠️ **Đại Hao HÃM + Hóa Kỵ / Phá Quân / sát tinh:** đam mê **cờ bạc, rượu chè**,
...
là một", con cái khó lòng trái ý.`,
  ...
  // ============================================================
  {
    ...
    cung: ['Phúc Đức'],
    doUuTien: 72,
    tomTat: `⚠️ **Đại Hao HÃM cư Phúc Đức:** **TIÊU HAO phúc lộc tổ tiên**, may
...
định tốt xấu.`,
  ...
  // ============================================================
  {
    ...
    cung: ['Điền Trạch'],
    doUuTien: 75,
    tomTat: `⚠️ **Đại Hao HÃM cư Điền:** thất thoát, **của thiên trả địa** —
...
⚠️ **Song Hao + Không Kiếp đắc địa:** điền sản **mua đi bán lại RẤT MAU**
...
⚠️ **Hãm địa:** cản trở công danh, sự nghiệp — chí hướng không bền, sự nghiệp
**trồi sụt**, khó ổn định lâu dài.`,
  ...
  // ============================================================
  {
    ...
    cung: ['Nô Bộc'],
    doUuTien: 70,
    tomTat: `⚠️ **Đại Hao cư Nô:** **khó thuê mướn người làm**, bị **tôi tớ trộm
...
⚠️ Cộng sự **không ổn định**, dễ **bị đâm sau lưng**. Hao hụt bạn bè, ít chơi
lâu bền.`,
  },
  ...
  // ============================================================
  {
    ...
    cung: ['Thiên Di'],
    doUuTien: 70,
    tomTat: `⚠️ **Đại Hao cư Thiên Di:** ra ngoài hay **tốn tiền, tổn hao NHIỀU**
(quy mô lớn).
...
⚠️ **NGOẠI LỆ — Đại Hao ĐẮC ĐỊA tại Tật:** không tốt — **tích tụ năng lượng
...
⚠️ **+ Kình / Đà / Không Kiếp / Hóa Kỵ:** đam mê (cờ bạc, rượu chè) sinh bệnh.`,
  ...
  // ============================================================
  {
    ...
    cung: ['Tài Bạch'],
    doUuTien: 80,
    tomTat: `⚠️ **Đại Hao cư Tài (HÃM):** đồng tiền **tán tụ thất thường** — **vào
...
Hao Hãm là **xấu nhất**.`,
  ...
  // ============================================================
  {
    ...
    cung: ['Tử Tức'],
    doUuTien: 70,
    tomTat: `⚠️ **Đại Hao HÃM cư Tử Tức:** **giảm số lượng con cái** — sinh nhiều
nhưng nuôi ít.

⚡ Con cái **không ở gần cha mẹ**, sống tự lập từ sớm.

⚠️ **TÍNH CHẤT MẠNH MẼ HƠN Tiểu Hao:** Đại Hao = quy mô lớn → con cái làm
...
🌟 **Đắc địa:** đầu tư cho con có **HIỆU QUẢ** → con cái thông minh, ham học.`,
  ...
  // ============================================================
  {
    ...
    cung: ['Phu Thê'],
    doUuTien: 75,
    tomTat: `⚠️ **Đại Hao cư Phu Thê:** không ưa — **giảm nhân duyên** vợ chồng.
...
khá giả**, giúp đỡ nhau về sau.`,
  ...
  // ============================================================
  {
    ...
    ketHop: ['Tham Lang'],
    doUuTien: 60,
    tomTat: `⚠️ **Đại Hao + Tham Lang đồng cung hoặc xung chiếu** (riêng Đại Hao):
...
⚠️ Cách cục này thường tiềm ẩn **rắc rối tình ái** sâu xa, khó phát hiện sớm
→ khi vỡ lở thì hậu quả lớn.`,
  ...
  // ============================================================
  {
    ...
    ketHop: ['Hóa Kỵ'],
    doUuTien: 60,
    tomTat: `⚠️ **Đại Hao + Hóa Kỵ:** **VẤT VẢ, TÚNG THIẾU**.
...
- Cuộc sống **nghèo khó kéo dài**`,
  ...
  // ============================================================
  {
    ...
    doUuTien: 60,
    tomTat: `⚠️ **Đại Hao + Hỏa Tinh / Linh Tinh** (riêng Đại Hao có thêm tính
**ngang bướng bảo thủ**):
...
- Tiêu tan **sự nghiệp, gia đình**`,
  ...
  // ============================================================
  {
    ...
    doUuTien: 65,
    tomTat: `⚠️ **Song Hao + Linh Tinh / Hỏa Tinh + Thiên Cơ + Thiên Riêu:**
...
⚠️ Nếu không tu tập đúng cách, dễ **lạc vào tà đạo** hoặc **bệnh tâm thần**.`,
  },
  ...
  // ============================================================
  {
    ...
    sao: ['Đại Hao'],
    doUuTien: 50,
    tomTat: `⚠️ **Hạn có Đại Hao:** **HAO TÀI TỐN CỦA quy mô LỚN**:
