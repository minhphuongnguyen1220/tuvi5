...
- Đây là **MẪU NGƯỜI LÃNH ĐẠO** — phù hợp với **chính trị, quân sự, hành pháp**.`,
...

  {
    ...
    doUuTien: 80,
    tomTat: `**Bạch Hổ HÃM địa tại Mệnh (Tý / Sửu / Thìn / Tỵ / Ngọ / Mùi / Tuất / Hợi):**
...
- Sao Bạch Hổ cần **đắc địa + sao GIẢI MẠNH** mới chế giảm được`,
...

  {
    ...
    doUuTien: 75,
    tomTat: `**Bạch Hổ Hãm + Sát Bại tinh (Lục Sát) tại Mệnh:** đem đến
**NHIỀU TAI HỌA**:
...
**Bạch Hổ + Thiên Hình + Không Kiếp + Hóa Kỵ:** dễ **DÍNH KIỆN TỤNG, RẮC RỐI
...
- **Không thích nhờ cậy** — tự thân lập nghiệp`,
...

  {
    ...
    trangThai: ['Hãm'],
    doUuTien: 65,
    tomTat: `**Bạch Hổ Hãm địa - Tài lộc:**
...
- Làm bao nhiêu cũng không đủ`,
...

  {
    ...
    cung: ['Mệnh'],
    doUuTien: 75,
    tomTat: `**Bạch Hổ thủ Mệnh - cảnh báo TAI HỌA:**
...
**Hôn nhân (đặc biệt cách "DUYÊN NỢ NGHIỆT DUYÊN"):**
...
ấm **YÊN BÌNH, ĐỦ ĐẦY**.`,
...

  {
    ...
    ketHop: ['Kình Dương'],
    doUuTien: 70,
    tomTat: `**Bạch Hổ + Kình Dương tại Mệnh:** **Khó thụ thai, sinh khó, sảy
thai, hậu sản**.`,
  },

  {
    ...
    ketHop: ['Đà La'],
    doUuTien: 70,
    tomTat: `**Bạch Hổ + Đà La tại Mệnh:** **Khó thụ thai, sinh khó, sảy thai,
hậu sản**.`,
  },

  {
    ...
    ketHop: ['Địa Kiếp'],
    doUuTien: 70,
    tomTat: `**Bạch Hổ + Địa Kiếp tại Mệnh:** **Khó thụ thai, sinh khó, sảy
thai, hậu sản**.`,
  },

  {
    ...
    ketHop: ['Thiên Hình'],
    doUuTien: 70,
    tomTat: `**Bạch Hổ + Thiên Hình tại Mệnh:** **Khó thụ thai, sinh khó, sảy
thai, hậu sản**.`,
  },

  {
    ...
    cung: ['Phụ Mẫu'],
    doUuTien: 75,
    tomTat: `**Bạch Hổ HÃM địa tại Phụ Mẫu:**
...
thể làm **QUAN CHỨC TO**, làm **CHỦ DOANH NGHIỆP**.`,
...

  {
    ...
    cung: ['Phúc Đức'],
    doUuTien: 75,
    tomTat: `**Bạch Hổ HÃM địa tại Phúc Đức:**
...
- Phát đạt, nổi danh về **học thuật**`,
...

  {
    ...
    ketHop: ['Kình Dương', 'Đà La', 'Hỏa Tinh', 'Linh Tinh', 'Địa Không', 'Địa Kiếp'],
    doUuTien: 73,
    tomTat: `**Bạch Hổ + Sát tinh (Lục Sát) tại Quan Lộc:**
...
Bản thân đương số hay phải **LO ÂU, QUAN TÂM** cho bạn bè, đồng nghiệp, cấp
...
**Hãm địa:** cần cẩn trọng, dễ dính **rắc rối, thị phi** với những người này.`,
  },
...
bản cung tương ứng).`,
...

  {
    ...
    cung: ['Tật Ách'],
    doUuTien: 80,
    tomTat: `**Bạch Hổ tại Tật Ách:** vấn đề **SỨC KHỎE** lớn — đặc biệt về **MÁU HUYẾT,
GÂN CỐT**:
- **Hoại huyết**, **HUYẾT ÁP CAO**
- **Đau gân, đau tim, NHỨC XƯƠNG, TÊ THẤP**
- **Nhiễm trùng máu**, tim mạch

**Đối với NỮ NHÂN:** ảnh hưởng MẠNH:
...
- Hay rơi vào trạng thái **U SẦU, BUỒN BÃ, BI QUAN**`,
...

  {
    ...
    doUuTien: 75,
    tomTat: `**Bạch Hổ + Thiên Hình + Liêm Trinh + Hóa Kỵ tại Tật Ách:** **TAI
...
- **Quản lý tài sản**, kinh doanh quy mô lớn`,
...

  {
    ...
    cung: ['Tài Bạch'],
    doUuTien: 70,
    tomTat: `**Bạch Hổ + Thiên Hình + Liêm Trinh + Hóa Kỵ tại Tài Bạch:**
...
- Hoặc bị **lừa gạt, mất trắng**`,
...

  {
    ...
    cung: ['Tử Tức'],
    doUuTien: 78,
    tomTat: `**Bạch Hổ tại Tử Tức:** ám chỉ đương số có **NHIỀU DUYÊN NỢ** với con cái
...
Vì là **DUYÊN NỢ TIỀN KIẾP** nên **PHẢI GẶP và PHẢI TRẢ**, **KHÔNG THỂ THOÁT**.`,
...

  {
    ...
    ketHop: ['Kình Dương'],
    doUuTien: 73,
    tomTat: `**Bạch Hổ + Kình Dương tại Tử Tức:** **KHÓ CÓ CON**, nặng hơn
thì **KHÔNG CÓ CON CÁI**.`,
...

  {
    ...
    ketHop: ['Thất Sát'],
    doUuTien: 73,
    tomTat: `**Bạch Hổ + Thất Sát tại Tử Tức:** **KHÓ CÓ CON**, nặng hơn thì
**KHÔNG CÓ CON CÁI**.`,
  },

  {
    ...
    ketHop: ['Địa Không'],
    doUuTien: 73,
    tomTat: `**Bạch Hổ + Địa Không tại Tử Tức:** **SINH NHIỀU NUÔI ÍT**, hay
**SẢY THAI**, có thể phải **NẠO PHÁ THAI**.`,
...

  {
    ...
    ketHop: ['Địa Kiếp'],
    doUuTien: 73,
    tomTat: `**Bạch Hổ + Địa Kiếp tại Tử Tức:** **SINH NHIỀU NUÔI ÍT**, hay
**SẢY THAI**, có thể phải **NẠO PHÁ THAI**.`,
  },

  {
    ...
    doUuTien: 70,
    tomTat: `**Bạch Hổ + Địa Không + Địa Kiếp + Thiên Hình tại Tử Tức:**
**SINH MỔ, KHÓ SINH** hoặc **con chết trong bụng mẹ**.`,
...

  {
    ...
    ketHop: ['Thai'],
    doUuTien: 73,
    tomTat: `**Bạch Hổ + Thai tại Tử Tức:** dễ **SẢY THAI**, **CON CHẾT NON**.`,
  },

  {
    ...
    cung: ['Phu Thê'],
    doUuTien: 80,
    tomTat: `**Bạch Hổ tại Phu Thê:** đương số có **NHIỀU DUYÊN NGHIỆP** với vợ/chồng.
...
nghiệp đương số — tuy nhiên cũng dẫn tới xu hướng **GIA TRƯỞNG** trong gia đình.`,
...

  {
    ...
    cung: ['Huynh Đệ'],
    doUuTien: 72,
    tomTat: `**Bạch Hổ tại Huynh Đệ:** ảnh hưởng **KHÔNG TỐT** đến mối quan hệ anh chị em.
...
Có thể là **HIỂU LẦM** hoặc **cách biệt tuổi tác và tính cách quá lớn** dẫn
...
- Lãnh đạo doanh nghiệp cần sự **quyết đoán**`,
...

  {
    ...
    ketHop: ['Tham Lang'],
    doUuTien: 65,
    tomTat: `**Bạch Hổ + Tham Lang:** ám chỉ **BỊ THÚ DỮ CẮN** — cần **CHÚ Ý** khi tiếp
xúc với động vật.
...
Cần **xem và kiểm tra HẠN** để nhận định **năm có tai họa**.
...
thú dữ**, **cẩn thận khi đi rừng/sở thú** trong các năm hạn xấu.`,
...

  {
    ...
    doUuTien: 78,
    tomTat: `**Bạch Hổ + Tang Môn + Điếu Khách + Phục Binh** = bộ **TỨ HUNG** — **rất ĐỘC**.
...
LIÊN TIẾP**, có **ĐẠI TANG**.`,
...

  {
    ...
    doUuTien: 55,
    tomTat: `**Bạch Hổ + Thiên Khốc + Thiên Mã:** **SÚC VẬT CHẾT vì BỆNH TẬT**.
...
- Ý nghĩa rộng: **mất mát tài sản di chuyển** (Mã chủ ngựa xe, di chuyển).`,
...

  {
    ...
    sao: ['Bạch Hổ'],
    doUuTien: 60,
    tomTat: `**Các tổ hợp BÁO HIỆU bị ÁC THÚ CẮN:**

**Bạch Hổ + Thiên Riêu** (Hổ Riêu)
**Bạch Hổ + Đà La + Hóa Kỵ + Thái Dương** (Hổ Đà Kỵ Nhật)
**Bạch Hổ + Đà La + Thiên Hình** (Hổ Đà Hình)
**Bạch Hổ + Thiên Khốc + Thiên Riêu** (Hổ Khốc Riêu)
**Bạch Hổ tại Dần + Địa Kiếp tại Tuất**
...
đi rừng, săn bắn, nuôi động vật hoang.`,
...

  {
    ...
    sao: ['Bạch Hổ'],
    doUuTien: 55,
    tomTat: `**Bạch Hổ vào hạn cần xem xét THẬT KỸ**, đặc biệt chú ý **CÁC BỘ SAO LƯU**:

Vì Bạch Hổ chủ về **MÁU HUYẾT, BỆNH TẬT, ỐM ĐAU, TÙ TỘI, TANG TÓC**, nên
**LƯU BẠCH HỔ** đi đến đâu sẽ mang theo **PHIỀN NÃO** ở đó.

**Tính cách trong hạn Bạch Hổ:**
