...
⚠️ Khi có thêm nhiều **ám tinh**: dấu hiệu liên quan **vong linh nam giới gắn
...
tiếng nói được coi trọng.`,
...

  {
    ...
    title: '⚠️ Tướng Quân + Thiên Hình lạc hãm tại Quan Lộc',
    sao: ['Tướng Quân'],
    ketHop: ['Thiên Hình'],
    trangThai: ['Hãm'],
    cung: ['Quan Lộc'],
    doUuTien: 75,
    tomTat: `⚠️ **Tướng Quân + Thiên Hình lạc hãm tại Quan Lộc:** công danh dễ
...
⚠️ Tuy có **cát tinh** đi kèm vẫn: người hôn phối **HAY GHEN TUÔNG**.`,
  },
...
**QUYỀN QUÝ**.`,
...

  {
    ...
    title: '⚠️ Tướng Quân + Phục Binh + Thai + Đế Vượng tại Huynh Đệ - dị bào',
    sao: ['Tướng Quân'],
    ketHop: ['Phục Binh', 'Thai', 'Đế Vượng'],
    cung: ['Huynh Đệ'],
    doUuTien: 67,
    tomTat: `⚠️ **Tướng Quân + Phục Binh + Thai + Đế Vượng tại Huynh Đệ** (Thai
...
→ Quyền uy và dũng mãnh gần như **bị triệt tiêu hoàn toàn**.`,
...

  {
    ...
    title: '⚠️ Tướng Quân + Tuần/Triệt + Thiên Hình - tăng nguy hại',
    sao: ['Tướng Quân'],
    ketHop: ['Tuần', 'Triệt', 'Thiên Hình'],
    doUuTien: 60,
    tomTat: `⚠️ **Tướng Quân + Tuần / Triệt + Thiên Hình:** mức nguy hại **tăng
...
trong **VẬN HẠN**.`,
...

  {
    ...
    title: '⚠️ Tướng Quân + Tuần/Triệt + Hóa Kỵ - tăng nguy hại',
    sao: ['Tướng Quân'],
    ketHop: ['Tuần', 'Triệt', 'Hóa Kỵ'],
    doUuTien: 60,
    tomTat: `⚠️ **Tướng Quân + Tuần / Triệt + Hóa Kỵ:** mức nguy hại **tăng
cao**, kéo theo nhiều **rắc rối, tai ương bất ngờ**, đặc biệt khi xuất hiện
trong **VẬN HẠN**.`,
  },

  {
    ...
    title: '⚠️ Tướng Quân + Tuần/Triệt + Kiếp Sát - tăng nguy hại',
    sao: ['Tướng Quân'],
    ketHop: ['Tuần', 'Triệt', 'Kiếp Sát'],
    doUuTien: 60,
    tomTat: `⚠️ **Tướng Quân + Tuần / Triệt + Kiếp Sát:** mức nguy hại **tăng
cao**, kéo theo nhiều **rắc rối, tai ương bất ngờ**, đặc biệt khi xuất hiện
trong **VẬN HẠN**.`,
  },
...
(Xem entries chuyên biệt theo giới tính, và cách Phá Quân + Phục Binh.)`,
...

  {
    ...
    title: '⚠️ Tướng Quân + Đào/Hồng + Phá Quân + Phục Binh - dâm dục loạn luân',
    sao: ['Tướng Quân'],
    ketHop: ['Đào Hoa', 'Hồng Loan', 'Phá Quân', 'Phục Binh'],
    doUuTien: 55,
    tomTat: `⚠️ **Tướng Quân + Đào Hoa / Hồng Loan + Phá Quân + Phục Binh:**
