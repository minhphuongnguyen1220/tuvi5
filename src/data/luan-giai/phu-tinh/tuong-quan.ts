...
- Dễ sa vào **NÓNG NẢY, hiếu thắng**, thậm chí **liều lĩnh thiếu cân nhắc**
...
nhưng không nhất thiết nắm được như Hóa Quyền.`,
  ...
  // ============================================================
  {
    ...
    cung: ['Mệnh'],
    doUuTien: 75,
    tomTat: `**NỮ MỆNH có Tướng Quân thủ Mệnh:**
...
**Mặt xấu:** trong gia đình **lấn át uy quyền của chồng**, hôn nhân dễ
...
Trong họ có người làm nên nhưng **bất hòa** — ai cũng có cá tính mạnh, dễ
xung đột.`,
  },
...
Khi có thêm nhiều **ám tinh**: dấu hiệu liên quan **vong linh nam giới gắn
với đất đai**: mọi quyết định mua bán, xây dựng cần **cân nhắc kỹ càng** để
tránh thiệt hại tài sản, sức khỏe, rủi ro.`,
  },
...
**UY QUYỀN**, có **óc lãnh tụ**, sức ảnh hưởng **đáng kể**.`,
...

  {
    ...
    cung: ['Quan Lộc'],
    doUuTien: 75,
    tomTat: `**Tướng Quân + Thiên Tướng tại Quan Lộc** = "Lưỡng Tướng trùng
phùng" — uy quyền **càng nổi bật**, được đồng nghiệp cấp dưới **kính nể** như
"tướng lĩnh cầm quân".`,
  },

  {
    ...
    cung: ['Quan Lộc'],
    doUuTien: 75,
    tomTat: `**Tướng Quân + Thiên Hình đắc địa tại Quan Lộc:** càng uy quyền,
tiếng nói được coi trọng.`,
  },

  {
    ...
    cung: ['Quan Lộc'],
    doUuTien: 75,
    tomTat: `**Tướng Quân + Thiên Hình lạc hãm tại Quan Lộc:** công danh dễ
gặp **biến cố** — từ vị trí cao có thể **bị giáng chức, nghỉ hưu sớm**, gặp
**tai họa nghề nghiệp**.`,
  },
...
Cảnh báo: thận trọng các mối quan hệ bạn bè, đồng nghiệp — tránh **bị lấn
át** hoặc **lạm quyền**.

Khi hội nhiều **cát tinh**: có **duyên gặp bạn bè TÀI GIỎI**, sẵn sàng
**giúp đỡ** trong công việc lẫn cuộc sống.`,
  },
...
**Mặt trái:** tự tin quá mức dễ sinh **kiêu căng, ngạo mạn** — tự **"gieo
họa vào thân"** lúc nào không hay.

**Khi xung chiếu thêm Phục Binh / Thất Sát / Liêm Trinh Thất Sát / Tử Phá /
...
**Mặt trái:** **NÓNG TÍNH, làm càn** thì hay **gặp rủi ro**, dễ bị **CẦM
GIỮ** (giam cầm).

Tướng Quân thường kéo theo **tai nạn bất ngờ, khó lường**:
- Vấn đề sức khỏe
...
**Mặt trái:** nếu không biết chi tiêu khéo léo, của cải dễ **"tiền vào như
...
Tính tình **cương trực, nóng nảy**, đôi khi **nghịch ngợm** như "**ngựa
...
Khi có thêm **cát tinh**: vợ/chồng có **địa vị xã hội**, được kính trọng,
hỗ trợ chủ mệnh trong công việc và quyết định quan trọng.

Tuy có **cát tinh** đi kèm vẫn: người hôn phối **HAY GHEN TUÔNG**.`,
  },
...
Bản mệnh đôi lúc bị anh em **lấn át**, chịu sức ép từ những người **có
tiếng nói hơn** mình.
...
khác cần học cách **nhường nhịn và thích ứng**.`,
...

  {
    ...
    cung: ['Huynh Đệ'],
    doUuTien: 67,
    tomTat: `**Tướng Quân + Thiên Mã + Lộc Tồn tại Huynh Đệ** = anh em
**QUYỀN QUÝ**.`,
  },

  {
    ...
    cung: ['Huynh Đệ'],
    doUuTien: 67,
    tomTat: `**Tướng Quân + Phục Binh + Thai + Đế Vượng tại Huynh Đệ** (Thai
Phục Vượng Tướng): anh chị em **DỊ BÀO** (khác mẹ/khác cha) hoặc có người
**DÂM ĐÃNG**.`,
  },
  ...
  // ============================================================
  {
    ...
    ketHop: ['Tuần', 'Triệt'],
    doUuTien: 65,
    tomTat: `**Tướng Quân + Tuần / Triệt án ngữ** = **"ÔNG TƯỚNG CỤT ĐẦU"** —
**CỰC XẤU**:
...
- Quyền uy và dũng mãnh gần như **bị triệt tiêu hoàn toàn**.`,
...

  {
    ...
    doUuTien: 60,
    tomTat: `**Tướng Quân + Tuần / Triệt + Thiên Hình:** mức nguy hại **tăng
cao**, kéo theo nhiều **rắc rối, tai ương bất ngờ**, đặc biệt khi xuất hiện
trong **VẬN HẠN**.`,
  },

  {
    ...
    doUuTien: 60,
    tomTat: `**Tướng Quân + Tuần / Triệt + Hóa Kỵ:** mức nguy hại **tăng
cao**, kéo theo nhiều **rắc rối, tai ương bất ngờ**, đặc biệt khi xuất hiện
trong **VẬN HẠN**.`,
  },

  {
    ...
    doUuTien: 60,
    tomTat: `**Tướng Quân + Tuần / Triệt + Kiếp Sát:** mức nguy hại **tăng
cao**, kéo theo nhiều **rắc rối, tai ương bất ngờ**, đặc biệt khi xuất hiện
trong **VẬN HẠN**.`,
  },
  ...
  // ============================================================
  {
    ...
    doUuTien: 65,
    tomTat: `**Tướng Quân + Phục Binh + Địa Không / Địa Kiếp:** **NGUY HIỂM
...
Cẩn trọng đặc biệt khi vận hạn đi vào cung này.`,
  },
  ...
  // ============================================================
  {
    ...
    doUuTien: 60,
    tomTat: `**Tướng Quân + Đào Hoa / Hồng Loan** — cách xấu cho phẩm hạnh.

(Xem entries chuyên biệt theo giới tính, và cách Phá Quân + Phục Binh.)`,
  },

  {
    ...
    doUuTien: 55,
    tomTat: `**Tướng Quân + Đào Hoa / Hồng Loan + Phá Quân + Phục Binh:**
**DÂM DỤC quá đáng**, **tư thông, ngoại dâm, LOẠN LUÂN**.`,
  },

  {
    ...
    gioiTinh: 'Nam',
    doUuTien: 55,
    tomTat: `**Tướng Quân + Đào Hoa / Hồng Loan - Nam mệnh:**
...
**HOANG DÂM** — đam mê sắc dục quá độ.`,
...

  {
    ...
    gioiTinh: 'Nữ',
    doUuTien: 55,
    tomTat: `**Tướng Quân + Đào Hoa / Hồng Loan - Nữ mệnh:**
...
Khi có thêm **Phúc thiện tinh** hóa giải: vợ chồng thường được **thử thách
bằng thời gian sống chung** trước khi về một nhà: vẫn ổn nếu vượt qua.`,
  },
