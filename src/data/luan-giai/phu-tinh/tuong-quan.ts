...
🌟 **Nữ mệnh có cách này:** đàn bà **đảm lược, tài ba, hoạt động như nam giới**.

⚠️ **Trong gia đình** (nữ mệnh): rất **có uy quyền**, thường **lấn át uy quyền
của chồng**.`,
  },
...
🌟 **+ Mệnh / Nô hội nhiều cát tinh:** có **duyên gặp bạn bè TÀI GIỎI**, sẵn
sàng **giúp đỡ** trong công việc lẫn cuộc sống.`,
  },
...
⚠️ **Mệnh + Phục Binh / Thất Sát / Liêm Trinh Thất Sát / Tử Phá / Tử Tham:**
đề phòng **rắc rối pháp lý, kiện tụng**, mâu thuẫn ngoài xã hội.`,
  },
...
⚠️ Cẩn trọng đặc biệt khi vận hạn đi vào cung này.`,
  ...
  // ============================================================
  {
    ...
    doUuTien: 60,
    tomTat: `⚠️ **Tướng Quân + Đào Hoa / Hồng Loan:**

- **Đàn bà:** tơ duyên **rắc rối**, **bị thất tiết**, **ngoại dâm**
- **Đàn ông:** **HOANG DÂM**
