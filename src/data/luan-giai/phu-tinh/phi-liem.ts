...
⚠️ **Khuyết điểm:** **NÓNG VỘI, hấp tấp**, làm nhanh, **không ưa suy nghĩ
...
⚡ Vì Phi Liêm chủ **nhanh chóng** → cha mẹ dễ **lấy nhau và có con TỪ SỚM**.`,
...

  {
    ...
    title: '⚠️ Phi Liêm tại Phụ Mẫu + Sát bại tinh - cha mẹ vất vả',
    sao: ['Phi Liêm'],
    cung: ['Phụ Mẫu'],
    ketHop: ['Kình Dương', 'Đà La', 'Hỏa Tinh', 'Linh Tinh', 'Địa Không', 'Địa Kiếp'],
    doUuTien: 65,
    tomTat: `⚠️ **Phi Liêm tại Phụ Mẫu + Sát bại tinh (Lục Sát):** cha mẹ **vất
...
⚡ Dòng họ nhiều người **đi xa làm ăn**.`,
...

  {
    ...
    title: '⚠️ Phi Liêm + Hình + Việt + Hỏa Linh + Không Kiếp tại Phúc Đức - chết đường chết chợ',
    sao: ['Phi Liêm'],
    cung: ['Phúc Đức'],
    ketHop: ['Thiên Hình', 'Thiên Việt', 'Hỏa Tinh', 'Linh Tinh', 'Địa Không', 'Địa Kiếp'],
    doUuTien: 60,
    tomTat: `⚠️ **Phi Liêm + Thiên Hình + Thiên Việt + Hỏa Tinh + Linh Tinh +
...
CHẾT CHỢ**, **nhà thờ thương binh liệt sĩ**.`,
...

  {
    ...
    cung: ['Điền Trạch'],
    doUuTien: 70,
    tomTat: `⚠️ **Phi Liêm cư Điền:** trong nhà **rất nhiều CÔN TRÙNG** — mối,
gián, kiến, ruồi, muỗi → ảnh hưởng sức khỏe, gây **bất tiện sinh hoạt**.

⚠️ Có thể **truyền mầm bệnh** nguy hiểm: **sốt xuất huyết, sốt rét, đau mắt,
bệnh đường tiêu hóa**.`,
  },

  {
    id: 'phi-liem-tai-dien-trach-dia-khong',
    title: '⚠️ Phi Liêm + Địa Không tại Điền Trạch - bom đạn pháo kích',
    sao: ['Phi Liêm'],
    cung: ['Điền Trạch'],
    ketHop: ['Địa Không'],
    doUuTien: 65,
    tomTat: `⚠️ **Phi Liêm + Địa Không tại Điền Trạch:** nơi ở thời chiến là
**khu vực nhạy cảm**, dễ trúng **bom đạn, pháo kích, súng ống**.`,
  },

  {
    id: 'phi-liem-tai-dien-trach-dia-kiep',
    title: '⚠️ Phi Liêm + Địa Kiếp tại Điền Trạch - bom đạn pháo kích',
    sao: ['Phi Liêm'],
    cung: ['Điền Trạch'],
    ketHop: ['Địa Kiếp'],
    doUuTien: 65,
    tomTat: `⚠️ **Phi Liêm + Địa Kiếp tại Điền Trạch:** nơi ở thời chiến là
**khu vực nhạy cảm**, dễ trúng **bom đạn, pháo kích, súng ống**.`,
  },

  {
    id: 'phi-liem-tai-dien-trach-linh-tinh',
    title: '⚠️ Phi Liêm + Linh Tinh tại Điền Trạch - bom đạn pháo kích',
    sao: ['Phi Liêm'],
    cung: ['Điền Trạch'],
    ketHop: ['Linh Tinh'],
    doUuTien: 65,
    tomTat: `⚠️ **Phi Liêm + Linh Tinh tại Điền Trạch:** nơi ở thời chiến là
**khu vực nhạy cảm**, dễ trúng **bom đạn, pháo kích, súng ống**.`,
  },

  {
    id: 'phi-liem-tai-dien-trach-hoa-tinh',
    title: '⚠️ Phi Liêm + Hỏa Tinh tại Điền Trạch - bom đạn pháo kích',
    sao: ['Phi Liêm'],
    cung: ['Điền Trạch'],
    ketHop: ['Hỏa Tinh'],
    doUuTien: 65,
    tomTat: `⚠️ **Phi Liêm + Hỏa Tinh tại Điền Trạch:** nơi ở thời chiến là
**khu vực nhạy cảm**, dễ trúng **bom đạn, pháo kích, súng ống**.`,
  },
...
⚠️ Dù làm lĩnh vực nào cũng cần **NGUYÊN TẮC, AN TOÀN, cẩn thận** — tránh
**"nghĩ ẩu làm liều"**.`,
  },

  {
    id: 'phi-liem-tai-quan-loc-sat-tinh',
    title: '⚠️ Phi Liêm + Sát tinh tại Quan Lộc - quyết định vội vàng',
    sao: ['Phi Liêm'],
    cung: ['Quan Lộc'],
    ketHop: ['Kình Dương', 'Đà La', 'Hỏa Tinh', 'Linh Tinh', 'Địa Không', 'Địa Kiếp'],
    doUuTien: 70,
    tomTat: `⚠️ **Phi Liêm + Sát tinh (Lục Sát) tại Quan Lộc:** công danh trắc
...
Thiên Di:** hay đi xa, được đi bằng **ĐƯỜNG HÀNG KHÔNG**.`,
...

  {
    ...
    cung: ['Tật Ách'],
    doUuTien: 78,
    tomTat: `⚠️ **Phi Liêm cư Tật:** **bệnh tật phát tác NHANH CHÓNG**.

⚠️ Ám chỉ các vật thể bay gây nguy hiểm: **TÊN, ĐẠN, LỬA ĐIỆN, SẤM SÉT, VI
...
- Dù làm công nghệ/kỹ thuật/lửa điện cũng phải **đề phòng nạn ách**`,
...

  {
    ...
    title: '⚠️ Phi Liêm + Sát tinh tại Tật Ách - tai nạn đột ngột',
    sao: ['Phi Liêm'],
    cung: ['Tật Ách'],
    ketHop: ['Kình Dương', 'Đà La', 'Hỏa Tinh', 'Linh Tinh', 'Địa Không', 'Địa Kiếp'],
    doUuTien: 73,
    tomTat: `⚠️ **Phi Liêm + Sát tinh (Lục Sát) tại Tật Ách:** đề phòng:
...
lại **chi tiêu cũng NHANH**, ít suy nghĩ.`,
...

  {
    ...
    title: '⚠️ Phi Liêm + Sát tinh tại Tài Bạch - dễ bị lừa lỗ vốn',
    sao: ['Phi Liêm'],
    cung: ['Tài Bạch'],
    ketHop: ['Kình Dương', 'Đà La', 'Hỏa Tinh', 'Linh Tinh', 'Địa Không', 'Địa Kiếp'],
    doUuTien: 67,
    tomTat: `⚠️ **Phi Liêm + Sát tinh (Lục Sát) tại Tài Bạch:** khó kiếm, dễ **bị
LỪA**, **đầu tư nóng vội bị LỖ**.`,
...

  {
    ...
    cung: ['Tử Tức'],
    doUuTien: 72,
    tomTat: `⚠️ **Phi Liêm cư Tử Tức:** **GIẢM SỐ LƯỢNG con cái**, không có lợi
cho thai sản → dễ **SINH NON**, **HIẾM MUỘN**.

⚠️ **Khả năng hiếm muộn TĂNG CAO** khi hội: Vũ Khúc / Thái Âm hãm / Phá Quân /
...
⚠️ Vì công việc bạn đời thường phải **DI CHUYỂN, đi lại NHIỀU** → vợ chồng
**hay phải xa cách**.`,
  },
...
→ Hổ vốn dũng mãnh, lại có thêm cánh để bay → uy lực + tốc độ → tột bậc.`,
...

  {
    ...
    doUuTien: 65,
    tomTat: `⚠️ **Phi Liêm + Thiên Việt + Hỏa Tinh + Thiên Hình:** bộ sao **CỰC
KỲ NGUY HIỂM** chủ về:
- **NẠN BINH ĐAO**
- **Bị SÚNG BẮN**
- **SÉT ĐÁNH, GIẬT ĐIỆN**
...
→ Những tai họa **xảy ra bất ngờ** — chủ mệnh cần **hết sức cẩn trọng**.`,
...

  {
    ...
    doUuTien: 60,
    tomTat: `⚠️ **Phi Liêm + Địa Không + Địa Kiếp:** chủ về **mất mát, phá tán**
điển hình.
