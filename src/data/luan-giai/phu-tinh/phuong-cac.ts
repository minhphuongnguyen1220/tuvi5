...
🌟 **+ Thiên Quan + Thiên Phúc:** càng **ỨNG NGHIỆM**.
...
nghiệp**.`,
...

  {
    ...
    doUuTien: 65,
    tomTat: `⚠️ **Phượng Các + Hóa Kỵ + Đà La + Không Kiếp:**
...
🌟 **+ Long Trì + Hoa Cái + Bạch Hổ** = bộ **TỨ LINH** tại Phúc Đức:
- Trong dòng họ nhiều người **ĐỖ KHOA BẢNG**
- Có **PHẨM HẠNH CAO**
- **MỒ MẢ tổ tiên ĐẸP, YÊN VỊ, PHÁT PHÚC**

🌟 **+ Hóa Khoa + Văn Xương + Thiên Khôi:**
...
🌟 **+ Thiên Cơ + Vũ Khúc + Tấu Thư + Lưu Hà:**
- Có thể làm **NHẠC SỸ, NGHỆ SỸ ÂM NHẠC NỔI TIẾNG**

🌟 **+ Quang Quý + Cơ Nguyệt Đồng Lương:**
- **BÁC SỸ TAI MŨI HỌNG**

🌟 **+ Vũ Khúc + Tấu Thư + Lưu Hà + Hồng Loan + Đào Hoa + Hoa Cái:**
- **NỔI DANH** trong lĩnh vực **ÂM NHẠC, NGHỆ THUẬT**`,
  },
...
🌟 **+ Tả Phù + Hữu Bật + Ân Quang + Thiên Quý:**
...
🌟 **+ Thiên Khôi + Thiên Việt + Long Trì:**
...
⚠️ **+ Hóa Kỵ + Đà La + Không Kiếp:**
- **TAI ĐIẾC, NGHỄNH NGÃNG**
...
🌟 **+ Tả Phù + Hữu Bật + Văn Xương + Văn Khúc + Hóa Khoa:**
...
🌟 **+ Long Trì + Ân Quang + Thiên Quý:**
- Tình duyên càng **ĐẸP**, càng **LÂU BỀN**
...
🌟 **+ Ân Quang + Thiên Quý + Thiên Phủ + Tử Vi + Thiên Tướng:**
...
⚠️ **Cảnh báo:** "**Phúc bất trùng lai, họa vô đơn chí**" — để giữ được phúc
