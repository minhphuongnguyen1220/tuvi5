...
là biết hóa giải Thái Tuế.`,
...

  {
    ...
    sao: ['Thái Tuế'],
    doUuTien: 60,
    tomTat: `⚠️ **Cung an Thân có Thái Tuế:** về già **DỄ CÔ ĐƠN, CÔ ĐỘC**, **khó tính**,
...
nhà nghiên cứu, nhà ngoại giao.`,
...

  {
    ...
    doUuTien: 60,
    tomTat: `⚠️ **Thái Tuế + Hoa Cái** hoặc **Thái Tuế + Hóa Kỵ:** đương số ăn nói **KIÊU
...
ngạo cô độc**.`,
...

  {
    ...
    ketHop: ['Thiên Hình'],
    doUuTien: 65,
    tomTat: `⚠️ **Thái Tuế + Thiên Hình:** chủ **TAI BAY VẠ GIÓ**, có thể bị **KIỆN, BỊ TÙ**.
...
→ Đặc biệt nguy hiểm ở **cung Tật Ách** hoặc **đại vận**.`,
...

  {
    ...
    ketHop: ['Đà La', 'Hóa Kỵ'],
    doUuTien: 60,
    tomTat: `⚠️ **Thái Tuế + Đà La + Hóa Kỵ:** đương số **QUÊ KỆCH, NGU ĐỘN**.
...
→ Khác với cách Khôi Việt + Xương Khúc làm sáng Thái Tuế — bộ này **làm tối** Thái Tuế.`,
...

  {
    ...
    doUuTien: 60,
    tomTat: `⚠️ **Thái Tuế + Thiên Riêu + Đà La:** người **HAY LẬT LỌNG**, **NÓI MỘT
ĐẰNG LÀM MỘT NẺO**.
...
→ Cách này **biến Thái Tuế từ chính trực thành xảo quyệt** — rất cần đề phòng.`,
...

  {
    ...
    doUuTien: 80,
    tomTat: `⚠️ **Thái Tuế tại cung DẦN hoặc DẬU + Thiên Hình + Kình Dương:** đại nạn
...
⚠️ **Thái Tuế + Thiên Hình, Thiên Riêu, Địa Không, Địa Kiếp, Kình Dương, Đà La,
...
- Cha mẹ phải **lao tâm khổ tứ** vì con.`,
...

  {
    ...
    cung: ['Phu Thê'],
    doUuTien: 78,
    tomTat: `⚠️ **Thái Tuế tại Phu Thê:** vợ chồng **BẤT HÒA**, hay **CÃI VÃ, LẮM LỜI**, có
...
⚠️ Trong anh chị em có người **CÔ ĐỘC, ĐAU BỆNH**.`,
  },
...
giúp đương số **trưởng thành**, mở ra hướng phát triển tích cực.`,
...

  {
    ...
    sao: ['Thái Tuế'],
    doUuTien: 55,
    tomTat: `⚠️ **Tiểu hạn (1 năm) gặp Thái Tuế:** **KHÔNG TỐT** chút nào — trái ngược
hoàn toàn với đại vận.

⚠️ Các biến cố có thể xảy ra:
...
- **KIỂM SOÁT CẢM XÚC** trong công việc và tình cảm — không quyết định vội
...

  {
    ...
    sao: ['Thái Tuế'],
    doUuTien: 50,
    tomTat: `⚠️ **Khái niệm Lưu Thái Tuế hàng năm:**
...
⚠️ **Nếu bảo thủ và nóng nảy:** dễ **CHUỐC HỌA VÀO THÂN**:
