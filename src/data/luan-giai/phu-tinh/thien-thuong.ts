...
**Cách dụng:** Khi luận hạn cần xem trước:
...
**Lưu ý quan trọng:** "GIẢI" ở đây không có nghĩa là sự việc **HOÀN TOÀN
...
- Cung Phúc nhiều sao tốt: giảm thiểu đáng kể`,
...

  {
    ...
    doUuTien: 60,
    tomTat: `**Thiên Thương + Văn Xương / Văn Khúc vào hạn** — cách **QUẾ SỨ HOA THƯƠNG**.
...
**Càng nguy hiểm khi:** thêm **THẤT SÁT, KÌNH ĐÀ, LINH TINH**: rủi
ro **CHẾT YỂU**.
...
nay nhiều yếu tố nguy hiểm đã được kiểm soát.`,
...

  {
    ...
    ketHop: ['Thiên Hình'],
    doUuTien: 55,
    tomTat: `**Thiên Thương + Thiên Hình vào hạn** — họa **"HÌNH THƯƠNG"** = **BỊ ĐÁNH**.
...
**Càng nghiêm trọng** khi có thêm **Phá Quân + Vũ Khúc + Thất Sát**:
- Hành động bạo lực mạnh hơn`,
...

  {
    ...
    cung: ['Nô Bộc'],
    doUuTien: 50,
    tomTat: `**Thiên Thương + Thiên Hình + Kiếp Sát + Phục Binh + Hóa Kỵ tại
Nô Bộc:** vết thương **TÂM LÝ ÂM Ỉ**, khó hồi phục.`,
...

  {
    ...
    ketHop: ['Tang Môn'],
    doUuTien: 55,
    tomTat: `**Thiên Thương + Tang Môn vào hạn** — điềm báo **MẤT MÁT ĐAU THƯƠNG**.
...
- Có thể **BIẾN ĐỔI PHI THƯỜNG**`,
...

  {
    ...
    doUuTien: 50,
    tomTat: `**Thiên Thương + Tang Môn + Đào Hoa + Thiên Việt vào hạn** (cung
tình cảm bất ổn):
...
- Trường hợp nặng: **CÁCH BIỆT ÂM DƯƠNG** với người thân cận`,
...

  {
    ...
    doUuTien: 55,
    tomTat: `**Thiên Thương + Thiên Sứ + Kình Dương + Hỏa Tinh + Thiên Riêu + Cự Môn**
— **HẠI CỦA, HẠI NGƯỜI**.
...
- Thận trọng giao thiệp lúc bệnh hoạn`,
...

  {
    ...
    doUuTien: 65,
    tomTat: `**Thương Sứ gặp Lục Sát Tinh vào hạn** — **NGUY MẠNG, có thể CHẾT**.
