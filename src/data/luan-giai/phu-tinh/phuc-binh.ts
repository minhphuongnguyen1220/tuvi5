...
⚠️ Khéo che giấu → đôi khi trở thành **khó đoán, lắm dã tâm, NHAM HIỂM** →
dễ bị xem là **kẻ xấu**.
...
Hình Tướng Ấn** chỉ cách **VÕ NGHIỆP UY QUYỀN**.`,
...

  {
    ...
    cung: ['Mệnh'],
    doUuTien: 78,
    tomTat: `⚠️ **Phục Binh thủ Mệnh:** người có tính **ĐỐ KỴ, cạnh tranh ngầm**,
...
TRẬN, chết đường chết chợ**.`,
...

  {
    ...
    cung: ['Điền Trạch'],
    doUuTien: 72,
    tomTat: `⚠️ **Phục Binh cư Điền:** nơi ở/làm việc dễ có **TRỘM CẮP** xung
quanh.

⚠️ Người **nhiều mưu mô, toan tính** về của cải, đất đai. **HOẶC** ngược lại
...
đất cát dễ có **VONG, có CỐT**.`,
...

  {
    ...
    cung: ['Quan Lộc'],
    doUuTien: 75,
    tomTat: `⚠️ **Phục Binh cư Quan:** công danh hay bị **TIỂU NHÂN RÌNH RẬP, DÈM
PHA**, công danh trắc trở.

⚠️ **HOẶC** đương số là người **đa mưu, nhiều kế**, sẵn sàng **CHƠI XẤU người
...
Tướng) tại Nô Bộc:** ra ngoài **NHIỀU bạn TÌNH**, quan hệ nam nữ phức tạp.`,
...

  {
    ...
    cung: ['Thiên Di'],
    doUuTien: 72,
    tomTat: `⚠️ **Phục Binh cư Di:** người tính mạnh mẽ, cương trực, thích **uy
...
lĩnh, mưu trí**.`,
...

  {
    ...
    cung: ['Tật Ách'],
    doUuTien: 75,
    tomTat: `⚠️ **Phục Binh cư Tật:** người hay **bị MẤT TRỘM, mất của**, tiền
bạc dễ bị người **sang đoạt, cướp giật, ăn chặn** hoặc **hao tán tài sản**.

⚠️ Dễ **bị người khác ÁM HẠI** hoặc **bệnh tật, tai họa BẤT NGỜ** xảy đến **không
kịp trở tay**.

⚠️ Bệnh có xu hướng **ẨN TÀNG, khó phát hiện sớm**.`,
  },
...
⚠️ **Lưu ý:** có thể bị **TAI HỌA BẤT NGỜ** về **súng đạn, đao kiếm** nếu vào
...
⚠️ **NỮ MỆNH** gặp bộ này: **CỰC XẤU**:
- Bị **LỪA TÌNH**
- **THẤT TRINH, THẤT TIẾT**
- Vướng các mối quan hệ **phức tạp** dẫn đến **xâm hại thể xác**

⚠️ Cung Mệnh / Phu Thê / Nô Bộc hoặc vận hạn có **Thai Phục Vượng Tướng** →
dễ có **quan hệ tình cảm trước hôn nhân**, **chung sống** rồi mới cưới.`,
...

  {
    ...
    doUuTien: 65,
    tomTat: `⚠️ **Phục Binh + Tướng Quân + Không Kiếp + Tả Phù + Hữu Bật:** có
