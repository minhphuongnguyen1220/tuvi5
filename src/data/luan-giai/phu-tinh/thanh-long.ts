...
đạt**, thường làm trong ngành **giáo dục, văn hóa, luật pháp**.`,
...

  {
    ...
    doUuTien: 67,
    tomTat: `**Thanh Long + Kình Dương / Đà La tại Phụ Mẫu:** cha mẹ dễ
**bệnh tật**, hay gặp **thị phi**, phải **vất vả lao tâm**.`,
...

  {
    ...
    doUuTien: 67,
    tomTat: `**Thanh Long + Địa Không / Địa Kiếp tại Phụ Mẫu:** cha mẹ dễ
**bệnh tật**, hay gặp **thị phi**, phải **vất vả lao tâm**.`,
  },

  {
    ...
    doUuTien: 67,
    tomTat: `**Thanh Long + Linh Tinh / Hỏa Tinh tại Phụ Mẫu:** cha mẹ dễ
**bệnh tật**, hay gặp **thị phi**, phải **vất vả lao tâm**.`,
  },
...
mẽ**.`,
...

  {
    ...
    ketHop: ['Hỏa Tinh'],
    doUuTien: 73,
    tomTat: `**Thanh Long + Hỏa Tinh tại Phúc Đức:** vướng **tai họa, pháp
luật**, có người **yểu mệnh**, đời sau khó hưởng trọn phúc phần.`,
...

  {
    ...
    ketHop: ['Địa Không', 'Địa Kiếp'],
    doUuTien: 73,
    tomTat: `**Thanh Long + Địa Không / Địa Kiếp tại Phúc Đức:** vướng **tai
...
**cao sang, rộng rãi**, khu dân cư **văn minh**.`,
...

  {
    ...
    ketHop: ['Kình Dương', 'Đà La'],
    doUuTien: 73,
    tomTat: `**Thanh Long + Kình Dương / Đà La tại Điền Trạch:** trắc trở mua
...
phong thủy không thuận.`,
...

  {
    ...
    ketHop: ['Hóa Kỵ'],
    doUuTien: 73,
    tomTat: `**Thanh Long + Hóa Kỵ tại Điền Trạch:** trắc trở mua bán/xây
...
thủy không thuận.`,
...

  {
    ...
    ketHop: ['Linh Tinh'],
    doUuTien: 73,
    tomTat: `**Thanh Long + Linh Tinh tại Điền Trạch:** trắc trở mua bán/xây
dựng/giữ gìn nhà đất. Nhà xuống cấp nhanh, **tranh chấp pháp lý** hoặc phong
thủy không thuận.`,
  },
...
danh **rực rỡ**, thi cử **đỗ cao**, sự nghiệp vững chắc.`,
...

  {
    ...
    ketHop: ['Hỏa Tinh'],
    doUuTien: 73,
    tomTat: `**Thanh Long + Hỏa Tinh tại Quan Lộc:** sự nghiệp **trắc trở**,
...
thành.`,
...

  {
    ...
    ketHop: ['Địa Không', 'Địa Kiếp'],
    doUuTien: 73,
    tomTat: `**Thanh Long + Địa Không / Địa Kiếp tại Quan Lộc:** sự nghiệp
...
Đặc trưng: kết giao với người **hào nhoáng bên ngoài** nhưng **thiếu chân
thành**: bản thân gặp trở ngại trong công việc, mất uy tín.`,
...

  {
    ...
    ketHop: ['Kình Dương', 'Đà La'],
    doUuTien: 67,
    tomTat: `**Thanh Long + Kình Dương / Đà La tại Nô Bộc:** mối quan hệ phức
tạp — bạn bè/đồng nghiệp gây **thị phi, ganh ghét, lợi dụng**.`,
...

  {
    ...
    ketHop: ['Linh Tinh'],
    doUuTien: 67,
    tomTat: `**Thanh Long + Linh Tinh tại Nô Bộc:** mối quan hệ phức tạp —
bạn bè/đồng nghiệp gây **thị phi, ganh ghét, lợi dụng**.`,
...

  {
    ...
    ketHop: ['Hỏa Tinh'],
    doUuTien: 67,
    tomTat: `**Thanh Long + Hỏa Tinh tại Nô Bộc:** mối quan hệ phức tạp —
bạn bè/đồng nghiệp gây **thị phi, ganh ghét, lợi dụng**.`,
  },
...
lại **rất gọn gàng chuẩn chỉ**.`,
...

  {
    ...
    ketHop: ['Linh Tinh', 'Hỏa Tinh'],
    doUuTien: 67,
    tomTat: `**Thanh Long + Linh Tinh / Hỏa Tinh tại Thiên Di:** vướng **thị
phi, tranh cãi**, nguy cơ **tai họa bất ngờ**.`,
...

  {
    ...
    ketHop: ['Địa Không', 'Địa Kiếp'],
    doUuTien: 67,
    tomTat: `**Thanh Long + Địa Không / Địa Kiếp tại Thiên Di:** vướng **thị
phi, tranh cãi**, nguy cơ **tai họa bất ngờ**.`,
  },
...
quan tới **ăn uống** (do hành Thủy).`,
...

  {
    ...
    ketHop: ['Kình Dương', 'Đà La'],
    doUuTien: 70,
    tomTat: `**Thanh Long + Kình Dương / Đà La tại Tật Ách:** dễ mắc **đầy
hơi, khó tiêu**, hoặc bệnh xuất phát từ **ăn uống không điều độ**.`,
...

  {
    ...
    ketHop: ['Linh Tinh'],
    doUuTien: 70,
    tomTat: `**Thanh Long + Linh Tinh tại Tật Ách:** dễ mắc **đầy hơi, khó
...
học càng giàu"** — thường làm việc trong môi trường **TRÍ THỨC, QUAN TRƯỜNG**.`,
...

  {
    ...
    ketHop: ['Đà La'],
    doUuTien: 70,
    tomTat: `**Thanh Long + Đà La tại Tài Bạch:** việc cầu tài **trở ngại**,
...
dụng.`,
...

  {
    ...
    ketHop: ['Địa Không', 'Địa Kiếp'],
    doUuTien: 70,
    tomTat: `**Thanh Long + Địa Không / Địa Kiếp tại Tài Bạch:** việc cầu tài
...
tiểu nhân lợi dụng.`,
...

  {
    ...
    ketHop: ['Linh Tinh', 'Hỏa Tinh'],
    doUuTien: 70,
    tomTat: `**Thanh Long + Linh Tinh / Hỏa Tinh tại Tài Bạch:** việc cầu tài
**trở ngại**, tiền kiếm được **khó giữ**, dễ vướng **kiện tụng tài chính**, bị
tiểu nhân lợi dụng.`,
  },
...
minh, giỏi giang, thành đạt, hiếu thảo**.`,
...

  {
    ...
    ketHop: ['Kình Dương', 'Đà La'],
    doUuTien: 70,
    tomTat: `**Thanh Long + Kình Dương / Đà La tại Tử Tức:** con cái **khó
...
con nhưng xa cách**, không sum vầy.`,
...

  {
    ...
    doUuTien: 70,
    tomTat: `**Thanh Long + Hỏa Tinh / Linh Tinh tại Tử Tức:** con cái **khó
nuôi**, **tính tình ngang ngạnh**. Một số trường hợp: **sinh ít con** hoặc **có
con nhưng xa cách**, không sum vầy.`,
  },
...
**Người hôn phối:** hiền hậu, **có học**, **quý hiển**, sống có tình nghĩa.`,
...

  {
    ...
    ketHop: ['Đà La'],
    doUuTien: 70,
    tomTat: `**Thanh Long + Đà La tại Phu Thê:** duyên phận **trắc trở**, vợ
chồng **bất hòa**, dễ **xa cách** vì công việc hoặc có sự **chia lìa**.`,
...

  {
    ...
    ketHop: ['Hỏa Tinh'],
    doUuTien: 70,
    tomTat: `**Thanh Long + Hỏa Tinh tại Phu Thê:** duyên phận **trắc trở**,
vợ chồng **bất hòa**, dễ **xa cách** vì công việc hoặc có sự **chia lìa**.`,
...

  {
    ...
    ketHop: ['Linh Tinh'],
    doUuTien: 70,
    tomTat: `**Thanh Long + Linh Tinh tại Phu Thê:** duyên phận **trắc trở**,
vợ chồng **bất hòa**, dễ **xa cách** vì công việc hoặc có sự **chia lìa**.`,
  },
...
làm **quan, làm thầy, luật sư** hoặc giữ vị trí **trí thức, uy tín**.`,
...

  {
    ...
    ketHop: ['Kình Dương', 'Đà La'],
    doUuTien: 67,
    tomTat: `**Thanh Long + Kình Dương / Đà La tại Huynh Đệ:** anh em **bất
...
người **yểu mệnh**.`,
...

  {
    ...
    ketHop: ['Địa Không', 'Địa Kiếp'],
    doUuTien: 67,
    tomTat: `**Thanh Long + Địa Không / Địa Kiếp tại Huynh Đệ:** anh em **bất
hòa, hiểu lầm, xa cách**. Trường hợp nặng: anh em **hình khắc**, trong nhà có
người **yểu mệnh**.`,
  },
...
- Thanh Long + Quan Đới = **Rồng đến lúc đăng quan**: công danh hiển đạt.`,
  ...
  // ============================================================
  {
    ...
    doUuTien: 55,
    tomTat: `**Thanh Long hội sát tinh** (Kình Dương / Đà La / Hỏa Tinh / Linh
...
còn uy nghiêm, dũng mãnh nữa.`,
...

  {
    ...
    doUuTien: 50,
    tomTat: `**Thanh Long + Không Kiếp + Kình Đà + Linh Hỏa + Hóa Kỵ đầy đủ:**
...
**đại phát**.`,
...

  {
    ...
    doUuTien: 45,
    tomTat: `**Thanh Long + Sát bại tinh (Lục Sát) vào hạn:** mất uy lực —
