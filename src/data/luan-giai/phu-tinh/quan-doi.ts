...
- ⚠️ Gặp Địa Không, Địa Kiếp, Tuần, Triệt → **CÔNG DANH KHÔNG BỀN**, không
  thọ, vất vả thời trẻ, mồ côi
- ⚠️ Gặp nhiều ám tinh → **RẮC RỐI, PHIỀN NHIỄU, NGĂN TRỞ**
- ⚠️ Gặp nhiều sát bại tinh → **TỰ TRÓI TỰ BUỘC**, "ôm rơm nặng bụng",
...
- Đặc biệt hợp người làm trong giới giải trí, truyền thông`,
...

  {
    ...
    doUuTien: 65,
    tomTat: `⚠️ **Quan Đới + Hỏa Tinh + Linh Tinh + Địa Kiếp + Địa Không + Kình Dương +
...
⚠️ **Cảnh báo:** Đây là cách cục cực xấu — cần Tứ Đức, Quan Phúc, Tuần
Triệt giải bớt.`,
  },

  {
    ...
    doUuTien: 60,
    tomTat: `⚠️ **Quan Đới + nhiều sát bại tinh + không có sao tốt cứu giải** — biến thành
...
giải bớt.`,
...

  {
    ...
    doUuTien: 55,
    tomTat: `⚠️ **Quan Đới + Linh Tinh + Hỏa Tinh** — đương số dễ rơi vào **CĂNG THẲNG
...
⚡ **Hóa giải:** Tu tập tịnh tâm, thiền định, Tứ Đức Quan Phúc giảm bớt.`,
...

  {
    ...
    doUuTien: 55,
    tomTat: `⚠️ **Quan Đới + Địa Không + Địa Kiếp + Tuần Triệt** — số mệnh **KHÔNG ĐƯỢC
...
⚠️ **Mặt tiêu cực** (gặp Địa Không, Địa Kiếp, Tuần, Triệt + sát bại tinh):
...
⚠️ **Mặt tiêu cực** (Thiên Hình, Không Kiếp, Kình Đà, sát bại tinh):
...
⚠️ **Mặt tiêu cực** (sát bại tinh, ám tinh):
...
⚠️ **Sát bại tinh hội** (Kình Đà, Hóa Kỵ, Riêu, Hỏa Linh):
