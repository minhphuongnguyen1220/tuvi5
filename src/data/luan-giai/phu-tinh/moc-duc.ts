...
- Bộ này hóa giải được tính dâm của Mộc Dục thành **DƯỠNG SINH HỌC**`,
...

  {
    ...
    doUuTien: 55,
    tomTat: `⚠️ **Mộc Dục + Đào Hoa + Hồng Loan + Thiên Riêu + sát tinh** — tính chất
...
⚡ **Đặc trưng:** Kiếm tiền bằng đôi tay khéo léo, không cần học vấn cao.`,
...

  {
    ...
    ketHop: ['Hóa Kỵ'],
    doUuTien: 50,
    tomTat: `⚠️ **Mộc Dục + Hóa Kỵ + nhiều hung sát bại tinh tại Tử Tức** — con cái
**HƯ HỎNG, PHÁ TÁN**.
...
⚠️ **Cảnh báo Mệnh VCD:** đặc tính hay thay đổi càng nổi bật, học hành
khó đỗ.`,
  },
...
⚠️ **Sát tinh hội (Không Kiếp + Kình Đà + Linh Hỏa + Hình Riêu + Hóa Kỵ):**
...
⚠️ **Sát tinh hội (Không Kiếp + Đà La + Đào Hồng):**
...
⚠️ **Sát tinh hội (Hóa Kỵ + Kình Đà + Không Kiếp):**
- Con cái dễ **HƯ HỎNG**
...
- ⚠️ Mặt tiêu cực: Sa đà tửu sắc, ngoại tình, hao tài
