...
- Hoặc nhận **CON ĐỠ ĐẦU CỦA NHÀ QUYỀN QUÝ**`,
...

  {
    ...
    doUuTien: 55,
    tomTat: `⚠️ **Dưỡng + Khốc Hư** — **SÁT CON, DỄ SẨY THAI**.
...
thì thành nghề **PHỤC DỊCH**.`,
...

  {
    ...
    doUuTien: 55,
    tomTat: `⚠️ **Dưỡng + Tướng Quân + Bệnh Phù** — đương số dễ rơi vào cảnh **VẤT VẢ
...
⚠️ **Dưỡng + Khốc Hư + Không Kiếp + Kình Đà + Hỏa Linh:**
