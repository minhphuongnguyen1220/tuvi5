...
- Đi cùng sát bại tinh: tính tốt bị lấn át, dễ thành **LƯỜI BIẾNG, Ỷ
...
- Quý cách cho người làm chính trị, công chức, giáo dục cao cấp`,
...

  {
    ...
    ketHop: ['Tuần', 'Triệt'],
    doUuTien: 55,
    tomTat: `**Tam Thai - Bát Tọa + Tuần / Triệt án ngữ** — phá vỡ **AN NHÀN VÀ MAY
MẮN** vốn có.
...
**MẤT TÍNH ĐÓ**.`,
...

  {
    ...
    ketHop: ['Tuần', 'Triệt'],
    doUuTien: 60,
    tomTat: `**Tam Thai - Bát Tọa + Tuần / Triệt án ngữ tại Mệnh / Tài Bạch / Quan
Lộc:**
...
- Đương số phải **NỖ LỰC NHIỀU** mới có thể đạt thành tựu`,
...

  {
    ...
    doUuTien: 55,
    tomTat: `**Tam Thai - Bát Tọa + Hồng Loan + Đào Hoa tại Mệnh / Nô Bộc / Phu Thê** —
...
**Đặc biệt nguy hiểm + Kình Đà / Không Kiếp / Hóa Kỵ / Thiên Riêu:**
...
- Mất danh dự`,
...

  {
    ...
    doUuTien: 55,
    tomTat: `**Tam Thai - Bát Tọa + nhiều sát bại tinh** — tính tốt **BỊ LẤN ÁT**, lười
biếng ỷ lại.
...
- **KHÓ LÀM NÊN NGHIỆP LỚN**`,
...

  {
    ...
    ketHop: ['Địa Không', 'Địa Kiếp'],
    doUuTien: 60,
    tomTat: `**Tam Thai - Bát Tọa + Địa Không + Địa Kiếp tại Tài Bạch:**
...
**Trường hợp gặp Địa Không + Địa Kiếp:**
