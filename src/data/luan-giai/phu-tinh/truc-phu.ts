...
**chu đáo**, biến **lo sợ** thành **cẩn trọng**.`,
...

  {
    ...
    doUuTien: 72,
    tomTat: `⚠️ **Trực Phù tại Mệnh + Kình Dương / Đà La / Linh Tinh / Hóa Kỵ:**

⚠️ **Nỗi LO SỢ** dễ biến thành:
- **MẶC CẢM**
- **ĐA NGHI QUÁ ĐỘ**
...
- Đời sau phải **TỰ GỒNG GÁNH**`,
...

  {
    ...
    cung: ['Điền Trạch'],
    doUuTien: 72,
    tomTat: `⚠️ **Trực Phù tại Điền Trạch:** sắc thái **TRẮC TRỞ** về nhà cửa, đất đai.
