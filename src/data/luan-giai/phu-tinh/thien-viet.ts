...
Nguyệt hãm — đây là cách cứu giải quý.`,
...

  {
    ...
    ketHop: ['Đà La', 'Hóa Kỵ'],
    doUuTien: 50,
    tomTat: `**Thiên Việt + Đà La + Hóa Kỵ:** **"kẻ sĩ ẩn dật"** — có tài nhưng
...
trong sự nghiệp.`,
...

  {
    ...
    doUuTien: 75,
    tomTat: `**Thiên Việt + Lục Sát tại Mệnh:** cảnh báo **tai họa bất ngờ** —
...
cộ**.`,
...

  {
    ...
    ketHop: ['Hóa Kỵ'],
    doUuTien: 75,
    tomTat: `**Thiên Việt + Hóa Kỵ tại Mệnh:** cảnh báo **tai họa bất ngờ** —
thương tích vùng **đầu, vai, thần kinh**.`,
...

  {
    ...
    ketHop: ['Thiên Hình'],
    doUuTien: 75,
    tomTat: `**Thiên Việt + Thiên Hình tại Mệnh:** cảnh báo **tai họa bất ngờ**
— thương tích vùng **đầu, vai, thần kinh**.`,
  },
...
**trời đất chở che**, **đông người trường thọ**, **nề nếp tốt đẹp truyền đời**.`,
...

  {
    ...
    doUuTien: 73,
    tomTat: `**Thiên Việt + Hỏa Tinh + Linh Tinh tại Phúc Đức:** trong họ dễ có
người **đoản mệnh hoặc tai nạn bất ngờ**, phúc khí khó giữ bền lâu.`,
...

  {
    ...
    ketHop: ['Thiên Hình'],
    doUuTien: 73,
    tomTat: `**Thiên Việt + Thiên Hình tại Phúc Đức:** trong họ dễ có người
**đoản mệnh hoặc tai nạn bất ngờ**, phúc khí khó giữ bền lâu.`,
...

  {
    ...
    ketHop: ['Hóa Kỵ'],
    doUuTien: 73,
    tomTat: `**Thiên Việt + Hóa Kỵ tại Phúc Đức:** trong họ dễ có người **đoản
...
phó trách nhiệm cộng đồng**.`,
...

  {
    ...
    ketHop: ['Hỏa Tinh', 'Linh Tinh'],
    doUuTien: 70,
    tomTat: `**Thiên Việt + Hỏa Tinh + Linh Tinh tại Điền Trạch:** đề phòng
**cháy nổ, chập điện**.`,
  },
...
địa vị** để mở cơ hội lớn.`,
  },
  {
    ...
    doUuTien: 73,
    tomTat: `**Thiên Việt + Tứ Sát (Kình Dương / Đà La / Hỏa Tinh / Linh Tinh)
...
duyên, quan hệ xã hội**.`,
  ...
  },
  {
    ...
    doUuTien: 73,
    tomTat: `**Thiên Việt + Hỏa Tinh / Linh Tinh / Thiên Hình / Thiên Riêu
...
cha mẹ **rạng nhà rạng cửa** nhờ con.`,
  },
  {
    ...
    doUuTien: 70,
    tomTat: `**Thiên Việt + Thiên Hình / Hỏa Tinh / Linh Tinh tại Tử Tức:**
