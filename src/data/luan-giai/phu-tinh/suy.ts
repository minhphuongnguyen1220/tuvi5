...
- **Tốt khi đi cùng sát bại tinh** + chính tinh hãm địa: **GIẢM TÁC DỤNG
  XẤU** của chúng
- **Xấu khi đi cùng cát tinh** đắc địa: **GIẢM ĐỘ SÁNG, SỨC PHÁT HUY**
  của chúng
...
- **DƯƠNG NAM, ÂM NỮ:** thường dễ bị **NGƯỜI HÔN PHỐI LẤN ÁT, CẦM QUYỀN**`,
...

  {
    ...
    doUuTien: 60,
    tomTat: `**Suy + Hỏa Tinh + Linh Tinh + Địa Không + Địa Kiếp + Thiên Cơ / Thiên
...
**Đặc biệt nguy hiểm tại Tuyệt - Suy - Mộc Dục:**
...
có để đỡ.`,
...

  {
    ...
    chi: ['Tý'],
    doUuTien: 55,
    tomTat: `**Suy tác động khi Cục Kim rơi vào hạn cung Tý** — chất lượng cuộc
sống **XUỐNG DỐC RÕ RỆT**.
...
nên làm nghề tiêu hao thể lực nhiều.`,
...

  {
    ...
    chi: ['Mão', 'Thìn', 'Tỵ'],
    doUuTien: 55,
    tomTat: `**Suy + Cục Thổ đến hạn Mão / Thìn / Tị** — thể chất dễ gặp **BIẾN
CHỨNG MÃN TÍNH**.
...
**Dương Nam, Âm Nữ:** dễ bị **NGƯỜI HÔN PHỐI LẤN ÁT, CẦM QUYỀN**, đông
...
**Đối ứng (do cấu trúc tam hợp):**
- Đương số dễ thủ **ĐẾ VƯỢNG**: bản thân dễ **TO BÉO**
- Hội nhiều cát tinh: bản thân dễ **THÀNH TÀI, THÀNH ĐẠT** giúp đỡ bố mẹ
...
**Hội sát bại tinh** (Hỏa Linh, Không Kiếp, Hóa Kỵ):
...
**Sát tinh hội** (Hóa Kỵ, Không Kiếp, Kiếp Sát):
...
**Hội nhiều sát bại tinh** (Hóa Kỵ, Đà La, Địa Kiếp):
...
**Đối ứng (do cấu trúc tam hợp):**
- Cung con cái có sao **ĐẾ VƯỢNG** hội nhiều cát tinh: dễ **SINH QUÝ TỬ**

**Cung này hội thêm sát tinh:**
