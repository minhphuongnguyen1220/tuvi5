...
export const luanGiai_ThienKhong: DoanLuanGiai[] = [
  {
    ...
    sao: ['Thiên Không'],
    doUuTien: 32,
    tomTat: `**Thiên Không** — phụ tinh **HUNG TINH**, sao **KHÔNG VONG** mang bản chất
**HƯ ẢO**.
...
- Khó **BỀN LÂU**
- Hôn nhân **DỞ DANG, LẬN ĐẬN**, phải **TÁI HÔN**
...
- **NGOAN NGOÃN, HIẾU THẢO, CHÍ TIẾN THỦ**
- Mang lại **NIỀM AN ỦI TINH THẦN** cho cha mẹ`,
  },
...
- Con cháu **KHÔNG ĐƯỢC HƯỞNG PHÚC ẤM**`,
  },
...
- Con cháu thừa hưởng **TINH THẦN ĐẠO LÝ**
- Dễ hướng đến **ĐỜI SỐNG TÂM LINH**`,
  },
...
- Bị **CẤP TRÊN CHÈN ÉP**
- Gặp chuyện **THỊ PHI, OAN SAI**
- Có năng lực nhưng **KHÓ ĐƯỢC TRỌNG DỤNG**
...
- Đi cùng **TẢ HỮU + THIÊN QUAN, THIÊN PHÚC + GIẢI THẦN**:
  ...
  - Có **QUÝ NHÂN GIÚP ĐỠ**
- Nhiều trường hợp **TƯỞNG NẶNG MÀ QUA KHỎI**
- **TUỔI THỌ KÉO DÀI**
- Sức khỏe ổn định nhờ **TU DƯỠNG, SỐNG LÀNH MẠNH**`,
  },
...
- Cuộc sống **THA HƯƠNG KHÓ YÊN**
- Phải **LAO ĐAO, PHIỀN MUỘN**
- Nên chú trọng **TÍCH ĐỨC, TU DƯỠNG**`,
  },
...
- Số lượng anh chị em **GIẢM** do **YỂU MỆNH** hoặc **SINH RA NHƯNG KHÔNG
  NUÔI ĐƯỢC**
- Chủ mệnh phải **TỰ LẬP**, ít được hỗ trợ ruột thịt`,
  },
