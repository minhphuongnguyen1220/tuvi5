...
export const luanGiai_HoaKy: DoanLuanGiai[] = [
  ...
  // ============================================================
  {
    ...
    sao: ['Hóa Kỵ'],
    doUuTien: 30,
    tomTat: `**Hóa Kỵ** thuộc bộ **Tứ Hóa** (Hóa Lộc, Hóa Quyền, Hóa Khoa, Hóa Kỵ),
ngũ hành **Thủy**.

**Hóa khí:** **Ác Tinh, Ám Tinh**.

**Đặc tính:** **thâm trầm, xảo trá, đố kỵ, thị phi, ganh ghét, sợ sệt, kiêng dè**.
...
**Lưu ý quan trọng:** **Phải có Hóa Kỵ thì MỚI có Hóa Khoa, Hóa Quyền, Hóa
Lộc** — Hóa Kỵ là phần KHÔNG THỂ THIẾU của Tứ Hóa.`,

    chiTiet: `## Bản chất "Kỵ"

Chữ **"Kỵ"** trong Hán có **bộ "Tâm"**: ý chỉ **ghen ghét, sợ sệt, kiêng dè**.

Hóa Kỵ giống như **lớp màng lọc** biến mọi thứ qua nó trở nên **xảo quyệt hơn,
...
trong các entry chuyên biệt bên dưới.`,
  },
  {
    ...
    doUuTien: 30,
    tomTat: `**Hóa Kỵ + sao học tập (Văn Xương / Văn Khúc / Thiên Khôi / Thiên
...
hoặc bằng cấp không dùng tới.`,
  },
  {
    ...
    doUuTien: 30,
    tomTat: `**Hóa Kỵ + Phúc thiện tinh (Ân Quang / Thiên Quý / Thiên Quan /
...
hay gặp trái ngang.`,
  },
  {
    ...
    ketHop: ['Cự Môn'],
    doUuTien: 30,
    tomTat: `**Hóa Kỵ + Cự Môn:** đặc tính **vạ miệng, thị phi qua lời nói**
RẤT RÕ RỆT.`,
  },
  {
    ...
    doUuTien: 30,
    tomTat: `**Hóa Kỵ + sát bại tinh (Kình / Đà / Hỏa / Linh / Không / Kiếp /
...
tiếng, bệnh tật, khó khăn.`,
  },
  {
    ...
    doUuTien: 30,
    tomTat: `**Hóa Kỵ + Thái Âm / Thái Dương:** bất luận cung nào cũng chủ về
**MẮT KÉM**, các **tật khúc xạ**, **đau mắt**.`,
  },
  {
    ...
    doUuTien: 30,
    tomTat: `**Hóa Kỵ + Thiên Riêu / Đà La / Linh Tinh / Hỏa Tinh / Thái Âm /
...
nhưng bản lĩnh**, "đi guốc trong bụng" người khác — thấu hiểu, dễ cảm thông.`,
...

  {
    ...
    trangThai: ['Hãm'],
    doUuTien: 78,
    tomTat: `**Hóa Kỵ Hãm địa tại Mệnh:** **mặc cảm, tự ti, hay tự trách bản thân**
...
trí và cảm xúc.`,
...

  {
    ...
    doUuTien: 75,
    tomTat: `**Hóa Kỵ tại Mệnh + Sát tinh:** càng **khép kín**, sống nội tâm quá
mức, **khó mở lòng**.`,
  },
...
**quá thiên lý trí mà thiếu hành động**.`,
...

  {
    ...
    doUuTien: 75,
    tomTat: `**Hóa Kỵ tại Mệnh + Thiên Không / Địa Kiếp / Linh Hỏa:** **dằn vặt,
...
hội cát tinh thì dễ thành **vụn vặt, không nhìn xa trông rộng**.`,
  },
  {
    ...
    ketHop: ['Cự Môn'],
    doUuTien: 45,
    tomTat: `**Hóa Kỵ + Cự Môn:** đặc điểm **vạ miệng** càng **thể hiện rõ** —
vạ miệng nặng, thị phi liên miên.`,
  ...
  // ============================================================
  {
    ...
    cung: ['Mệnh'],
    doUuTien: 78,
    tomTat: `**Hóa Kỵ tại Mệnh - bệnh tật & tai họa:**
...
**Sự nghiệp:** **ích kỷ, khó hòa nhập**: công danh khó khăn.`,
...

  {
    ...
    doUuTien: 73,
    tomTat: `**Hóa Kỵ tại Mệnh + Thái Dương / Linh Hỏa:** bệnh thần kinh, tinh thần
...
Cha mẹ **bất hòa, xung khắc** với nhau hoặc **cha mẹ - con cái không hợp tính**.
...
khỏe ổn định, cuộc sống yên bình.`,
...

  {
    ...
    trangThai: ['Hãm'],
    doUuTien: 70,
    tomTat: `**Hóa Kỵ Hãm địa tại Phụ Mẫu:** tình cảm **rạn nứt do nhân sinh quan
khác nhau**, sức khỏe cha mẹ yếu.`,
...

  {
    ...
    doUuTien: 67,
    tomTat: `**Hóa Kỵ Hãm địa + Địa Kiếp / Kình Dương tại Phụ Mẫu:** **biến cố gia
đình, tổn thương sâu sắc**.`,
  ...
  // ============================================================
  {
    ...
    cung: ['Phúc Đức'],
    doUuTien: 78,
    tomTat: `**Hóa Kỵ tại Phúc Đức:** **kém may mắn, tổn thọ**, "**làm phúc phải
tội**", **tai vạ thị phi với họ hàng**.

Ít quan tâm **thờ cúng tổ tiên**, mồ mả tổ tiên có nơi **bị ngập nước**.

Người Hóa Kỵ tại Phúc dễ **giảm nhân duyên với hôn phối**, **bất hòa với gia
đình hôn phối**.`,
  },

  {
    ...
    ketHop: ['Kình Dương', 'Đà La', 'Hỏa Tinh', 'Linh Tinh'],
    doUuTien: 73,
    tomTat: `**Hóa Kỵ tại Phúc Đức + Sát tinh:** dòng họ có người **bị điên, bệnh
thần kinh, phù thủng**.`,
  },

  {
    ...
    doUuTien: 73,
    tomTat: `**Hóa Kỵ tại Phúc Đức + Không Kiếp:** thời vận dòng họ **suy bại, nghèo
nàn**.`,
  },
...
phúc phần **bền vững**, tâm tính **lương thiện**.`,
  ...
  // ============================================================
  {
    ...
    cung: ['Điền Trạch'],
    doUuTien: 75,
    tomTat: `**Hóa Kỵ tại Điền Trạch:** trong đời ít nhất có lần **bán nhà bán
đất hoặc phá sản**.
...
gia sản.`,
...

  {
    ...
    trangThai: ['Hãm'],
    doUuTien: 72,
    tomTat: `**Hóa Kỵ Hãm địa tại Điền Trạch:** **tha hương, chuyển dời nhiều nơi**.
**Tranh chấp đất đai, rắc rối giấy tờ**, mua nhầm nhà phong thủy xấu.`,
...

  {
    ...
    doUuTien: 70,
    tomTat: `**Hóa Kỵ Hãm địa tại Điền Trạch + Địa Kiếp / Kiếp Sát:** bị **lừa, tổn
thất** đầu tư bất động sản.`,
  ...
  // ============================================================
  {
    ...
    cung: ['Quan Lộc'],
    doUuTien: 78,
    tomTat: `**Hóa Kỵ tại Quan Lộc:** **trắc trở công danh**, chậm thăng tiến.
...
**Tai tiếng, thị phi, dính pháp luật**. Đặt lợi ích cá nhân lên trên, sẵn
...
sư, y học, giáo dục, tôn giáo, nghệ thuật**. **"Nước chảy đá mòn"**.`,
...

  {
    ...
    trangThai: ['Hãm'],
    doUuTien: 75,
    tomTat: `**Hóa Kỵ Hãm địa tại Quan Lộc:** lên xuống thất thường, làm việc **đơn
độc**, không được hỗ trợ tích cực.`,
  ...
  // ============================================================
  {
    ...
    cung: ['Nô Bộc'],
    doUuTien: 72,
    tomTat: `**Hóa Kỵ tại Nô Bộc:** bạn bè đồng nghiệp **"bằng mặt không bằng
lòng"**, **bị nói xấu, oán hại**.

**Thị phi, kiện tụng, tranh chấp** với bạn bè đồng nghiệp, **tai tiếng xấu**.
Khó liên kết do **cái tôi quá lớn**.`,
...

  {
    ...
    doUuTien: 70,
    tomTat: `**Hóa Kỵ tại Nô Bộc + Phá Quân / Tang Môn:** "làm ơn mắc oán".`,
  },

  {
    ...
    doUuTien: 70,
    tomTat: `**Hóa Kỵ tại Nô Bộc + Đào Hoa / Hồng Loan / Mộc Dục:** **nghiệp duyên
...
quan hệ **bền vững**, nhận **hỗ trợ âm thầm**.`,
...

  {
    ...
    ketHop: ['Địa Kiếp'],
    doUuTien: 70,
    tomTat: `**Hóa Kỵ Hãm địa + Địa Kiếp tại Nô Bộc:** gặp **người xấu / tiểu nhân**
gây rối, tổn thương tình cảm.`,
  ...
  // ============================================================
  {
    ...
    cung: ['Thiên Di'],
    doUuTien: 75,
    tomTat: `**Hóa Kỵ tại Thiên Di:** ra ngoài **nhiều tai tiếng, thị phi**.
...
soi mói**. Tới lui những **nơi ồn ào, lắm thị phi**.`,
...

  {
    ...
    doUuTien: 72,
    tomTat: `**Hóa Kỵ tại Thiên Di + Thái Tuế / Thiên Hình / Bạch Hổ / Quan Phù:** dính
**pháp luật, kiện tụng**.`,
  },
...
Xây mạng lưới quan hệ **bền vững**, được **giúp đỡ từ người xa lạ**.`,
  ...
  // ============================================================
  {
    ...
    cung: ['Tật Ách'],
    doUuTien: 78,
    tomTat: `**Hóa Kỵ tại Tật Ách:** **thường xuyên bệnh, tai nạn, khó khăn sinh
...
Hành Thủy: cẩn thận **sông nước, máu huyết**, **bệnh tinh thần thần kinh**.`,
...

  {
    ...
    ketHop: ['Thiên Riêu', 'Đà La', 'Linh Tinh', 'Hỏa Tinh', 'Thái Âm', 'Thái Dương', 'Thiên Đồng'],
    doUuTien: 75,
    tomTat: `**Hóa Kỵ tại Tật Ách + Thiên Riêu / Đà La / Linh Hỏa / Âm Dương / Thiên
Đồng:** bệnh **TÂM LINH** — **bị cơ hành, dở điên dở dại**.`,
...

  {
    ...
    ketHop: ['Thái Âm', 'Thái Dương'],
    doUuTien: 73,
    tomTat: `**Hóa Kỵ tại Tật Ách + Thái Âm / Thái Dương:** **MẮT KÉM, tật khúc xạ,
đau mắt**.`,
  },
...
lành cao** dù có vấn đề sức khỏe tiềm ẩn. Sinh hoạt điều độ.`,
  ...
  // ============================================================
  {
    ...
    cung: ['Tài Bạch'],
    doUuTien: 75,
    tomTat: `**Hóa Kỵ tại Tài Bạch:** dễ **hao tán tiền bạc**.

**Đặt nặng vấn đề tiền bạc, lợi ích bản thân**: **tai tiếng thị phi kiện
tụng** liên quan tiền bạc.

Có thể kiếm tiền từ **tranh chấp / kiện tụng** — làm nghề **thẩm phán, luật sư**.

Là ám tinh: chỉ thấy **lợi ích NGẮN HẠN**, bỏ qua **lợi ích lâu dài**.`,
  },

  {
    ...
    ketHop: ['Phục Binh'],
    doUuTien: 72,
    tomTat: `**Hóa Kỵ tại Tài Bạch + Phục Binh:** dễ bị **trộm cắp**, bị **cướp công
cướp của**.`,
  },
...
chi tiêu**, tích lũy **âm thầm không phô trương**.`,
...

  {
    ...
    doUuTien: 70,
    tomTat: `**Hóa Kỵ Hãm địa + Không Kiếp / Kình Dương tại Tài Bạch:** **rủi ro
pháp lý tài chính, lừa đảo, thua lỗ lớn** do thiếu minh bạch.`,
  ...
  // ============================================================
  {
    ...
    cung: ['Tử Tức'],
    doUuTien: 72,
    tomTat: `**Hóa Kỵ tại Tử Tức:** **cha mẹ - con cái xung khắc**, không hòa
thuận, **tranh giành thiệt hơn**.`,
...

  {
    ...
    doUuTien: 70,
    tomTat: `**Hóa Kỵ tại Tử Tức + Sát bại tinh:** **ÍT CON, con khó nuôi, khó dạy**,
...
**giỏi giang, hiếu thảo, niềm tự hào**.`,
...

  {
    ...
    trangThai: ['Hãm'],
    doUuTien: 70,
    tomTat: `**Hóa Kỵ Hãm địa tại Tử Tức:** khó sinh / nuôi, con cái **vấn đề sức
khỏe / tinh thần**, quan hệ **xa cách, hiểu lầm kéo dài**.`,
  ...
  // ============================================================
  {
    ...
    cung: ['Phu Thê'],
    doUuTien: 78,
    tomTat: `**Hóa Kỵ tại Phu Thê:** vợ chồng **cãi vã, bất hòa thường xuyên**,
**hay ghen, nghi kỵ, soi xét nhau từng tí**. Nhân duyên giảm.`,
...

  {
    ...
    ketHop: ['Phục Binh'],
    doUuTien: 75,
    tomTat: `**Hóa Kỵ tại Phu Thê + Phục Binh:** vợ chồng **bất hòa, lúc lấy gặp cản
trở, mưu hại lẫn nhau** hoặc **bị người ngoài chia rẽ**.`,
...

  {
    ...
    doUuTien: 75,
    tomTat: `**Hóa Kỵ tại Phu Thê + Đào Hoa / Hồng Loan:** **NGOẠI TÌNH, lừa dối nhau**.`,
  },

  {
    ...
    ketHop: ['Thiên Riêu'],
    doUuTien: 75,
    tomTat: `**Hóa Kỵ tại Phu Thê + Thiên Riêu:** vợ/chồng **ham chơi, phóng đãng**,
dễ có **người khác bên ngoài**.`,
...

  {
    ...
    doUuTien: 75,
    tomTat: `**Hóa Kỵ tại Phu Thê + Địa Kiếp / Thiên Hình / Thiên Riêu:** một người
...
hòa nhường nhịn**. Vợ chồng **"nghĩa nặng tình sâu"**, âm thầm bền vững.`,
  ...
  // ============================================================
  {
    ...
    cung: ['Huynh Đệ'],
    doUuTien: 72,
    tomTat: `**Hóa Kỵ tại Huynh Đệ:** anh chị em **xung khắc, bất hòa, tranh
giành tài sản**, khó ở chung, thậm chí **kiện tụng lẫn nhau**.

**Âm dương nghịch lý:** mệnh tạo **tuổi nhỏ gặp nhiều tai họa, tai tiếng**.`,
  },
...
đỡ**. Đương số bình tĩnh thận trọng, đứng ra **hòa giải tranh chấp**.`,
...

  {
    ...
    trangThai: ['Hãm'],
    doUuTien: 70,
    tomTat: `**Hóa Kỵ Hãm địa tại Huynh Đệ:** quan hệ **căng thẳng**, có thể gặp
...
thiếu hỗ trợ khi khó khăn hoạn nạn.`,
  ...
  // ============================================================
  {
    ...
    sao: ['Hóa Kỵ'],
    doUuTien: 55,
    tomTat: `**Hạn đến Hóa Kỵ - 4 hung họa lớn:**

1. **OÁN THÙ MƯU HẠI:** rơi vào vòng **thị phi**, bị **ghen tỵ ngấm ngầm mưu hại**
   - cần **giữ miệng**, "uốn lưỡi 7 lần trước khi nói"
2. **ỐM ĐAU TAI NẠN:** đặc biệt **sông hồ, ao suối** (Hóa Kỵ Thủy). Cần **nghỉ
   ngơi, bồi bổ, thăm khám sớm**
3. **TÌNH DUYÊN TRẮC TRỞ:** đôi lứa nảy sinh **hiểu lầm, xa cách**: cần **cảm
   thông, nhường nhịn, chia sẻ**
4. **CHA MẸ MẤT SỚM:** một trong những nỗi đau lớn nhất — "cây mất gốc, sông
   mất nguồn"`,
  },
  ...
  // ============================================================
  {
    ...
    sao: ['Hóa Kỵ'],
    doUuTien: 40,
    tomTat: `**Hóa giải Hóa Kỵ:**

1. **Tiết chế lời ăn tiếng nói** — tránh chủ đề nhạy cảm, dễ tranh cãi
2. **Quan sát và tìm hiểu kỹ bản chất** sự việc trước khi phản ứng
3. **Khiêm nhường**, tránh "ăn miếng trả miếng" khi bị hiểu nhầm
4. **Nguyên tắc giao tiếp rõ ràng** để không rơi vào tình huống bất lợi

**HƯỚNG NĂNG LƯỢNG vào HỌC TẬP, NGHIÊN CỨU, ĐÀO SÂU CHUYÊN MÔN:**
- Hóa Kỵ trong môi trường học thuật / nghiên cứu giúp **đào sâu vấn đề, tìm
  bản chất**
- Biến **"khúc mắc" thành "phát hiện"**

- Hóa Kỵ trở thành **động lực** rèn:
- **Sự kiên nhẫn**
- **Sự thận trọng**
