...
hội cát tinh thì dễ thành **vụn vặt, không nhìn xa trông rộng**.`,
  ...
  // ============================================================
  {
    ...
    cung: ['Mệnh'],
    doUuTien: 78,
    tomTat: `⚠️ **Hóa Kỵ tại Mệnh - bệnh tật & tai họa:**
...
đình, tổn thương sâu sắc**.`,
  ...
  // ============================================================
  {
    ...
    cung: ['Phúc Đức'],
    doUuTien: 78,
    tomTat: `⚠️ **Hóa Kỵ tại Phúc Đức:** **kém may mắn, tổn thọ**, "**làm phúc phải
...
phúc phần **bền vững**, tâm tính **lương thiện**.`,
  ...
  // ============================================================
  {
    ...
    cung: ['Điền Trạch'],
    doUuTien: 75,
    tomTat: `⚠️ **Hóa Kỵ tại Điền Trạch:** trong đời ít nhất có lần **bán nhà bán
đất hoặc phá sản**.
...
thiếu hỗ trợ khi khó khăn hoạn nạn.`,
  ...
  {
    id: 'hoa-ky-han',
    title: '⚠️ Hóa Kỵ vào hạn - 4 hung họa',
    sao: ['Hóa Kỵ'],
    doUuTien: 55,
    tomTat: `⚠️ **Hạn đến Hóa Kỵ - 4 hung họa lớn:**
