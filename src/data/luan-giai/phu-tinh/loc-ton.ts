...
⚠️ Vì Kình Đà giáp Mệnh → con đường công danh **luôn có cạnh tranh, đố kỵ, thị
...
🌟 **Khi vào hạn:** mưu sự **toại lòng**, **danh tài hưng vượng** đồng thời.`,
  ...
  // ============================================================
  {
    ...
    doUuTien: 60,
    tomTat: `⚠️ **Lộc Tồn + Tuần / Triệt / Phá Toái:** một trong 3 sao này gần
...
- Tài vận **trắc trở**, dễ thất thoát`,
  ...
  // ============================================================
  {
    ...
    doUuTien: 62,
    tomTat: `⚠️ **Lộc Tồn + Địa Không / Địa Kiếp** = cách **"Lộc phùng Không Kiếp"**
...
⚠️ **Khi vào hạn:** Lộc Tồn + Không Kiếp → **đau yếu, mắc lừa, của tiền khó
bền**.
...
sẵn có**.`,
  ...
  // ============================================================
  {
    ...
    doUuTien: 60,
    tomTat: `⚠️ **Lộc Tồn + Hóa Kỵ + Thái Tuế:** chủ về **có tiền nhưng bị hao
...
**con đường không minh bạch** gây tai tiếng.`,
  ...
  // ============================================================
  {
    ...
    ketHop: ['Thiên Không'],
    doUuTien: 58,
    tomTat: `⚠️ **Lộc Tồn + Thiên Không:** ăn **tham nhũng hối lộ**, bị **thị
...
chỉ là **tạm thời**, sau đó sẽ bị **Thiên Không phá tan vào thời điểm bất ngờ**.`,
  ...
  // ============================================================
  {
    ...
    ketHop: ['Cự Môn'],
    doUuTien: 58,
    tomTat: `⚠️ **Lộc Tồn + Cự Môn:** **phá sức sáng** của Lộc Tồn rất nhiều.
...
- ⚠️ **Lộc Tồn + Không Kiếp:** **đau yếu, mắc lừa**, của tiền **khó bền lâu**`,
  },
