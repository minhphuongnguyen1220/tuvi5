...
export const luanGiai_QuanPhu: DoanLuanGiai[] = [
  {
    ...
    sao: ['Quan Phủ'],
    doUuTien: 30,
    tomTat: `**Quan Phủ** — phụ tinh **PHÙ TINH + HÌNH TINH** trong **vòng Lộc Tồn**
(vị trí thứ **12 - cuối cùng**).
...
**Vị thế trong vòng:**
- Nằm trong **TAM HỢP với Hỷ Thần và Tiểu Hao**
- **LUÔN xung chiếu với Tấu Thư** (cách 6 cung)

**Đặc tính:** **lý luận, quan tụng, thông minh, sắc bén, KHẮT KHE**.

**Bản chất 2 mặt:**
- **Mặt tốt:** lý luận sắc bén, soi xét đúng sai, **MINH BẠCH** trong luật
  pháp: người **cầm cân nảy mực**
- **Mặt xấu:** **KIỆN CÁO, THỊ PHI**, biện bác, đơn từ, **tranh chấp**

Vì xung chiếu Tấu Thư (đơn từ): **chủ về ĐƠN KIỆN, THƯA KIỆN, biện luận**.`,
  },
...
**Tinh thần CẠNH TRANH, ĐỐ KỴ, NẶNG BÁO PHỤC** — sẵn sàng dùng thủ đoạn
...
- Mẫu người làm việc theo **NGUYÊN TẮC và LOGIC**, "**người cầm cân nảy mực**".`,
  },
  {
    ...
    doUuTien: 73,
    tomTat: `**Quan Phủ + Sát bại tinh (Kình / Đà / Hỏa / Linh / Không / Kiếp /
...
- HOẶC bị **oán, báo thù, kiện, phản bội**`,
...

  {
    ...
    cung: ['Phụ Mẫu'],
    doUuTien: 70,
    tomTat: `**Quan Phủ cư Phụ Mẫu + cát tinh + văn tinh:** cha mẹ làm nghề
**hành pháp, pháp luật**, hành chính, các nghề đòi hỏi **công tâm, minh
bạch**.

Cha mẹ dễ **BẤT HÒA, cãi nhau** vì trái ngược quan điểm.`,
  },
  {
...
- Xa cách vì **bất hòa tư tưởng**`,
...

  {
    ...
    cung: ['Phúc Đức'],
    doUuTien: 70,
    tomTat: `**Quan Phủ cư Phúc Đức:** trong dòng họ nhiều người **ƯA LÝ LẼ**,
dễ sa vào **TRANH CÃI, KIỆN TỤNG** lẫn nhau vì bất đồng quan điểm.

Mâu thuẫn thường về **quyền lợi, đất đai, hương hỏa, mồ mả tổ tiên**.

Dễ có **bất đồng, cãi nhau** trong việc **THỜ CÚNG, mồ mả tổ tiên**.
...
**LÀM QUAN LỚN**, khắt khe và **quyền biến**.`,
...

  {
    ...
    cung: ['Điền Trạch'],
    doUuTien: 72,
    tomTat: `**Quan Phủ cư Điền:** nhà cửa **GẦN nơi CÔNG MÔN, CÔNG QUYỀN** —
**TÒA ÁN, VIỆN KIỂM SÁT, CÔNG AN, ỦY BAN**.

Người **dễ mắc TRANH TỤNG, KIỆN CÁO** về **điền sản, đất đai**:
- Rắc rối **giấy tờ, quyền sử dụng đất**
- Tranh chấp **chia tài sản**

Người **khó tính** hoặc **hàng xóm khó tính**: dễ **bất đồng**, dễ bị
**thưa kiện** vì những điều nhỏ nhặt.`,
  },

  {
    ...
    cung: ['Quan Lộc'],
    doUuTien: 78,
    tomTat: `**Quan Phủ cư Quan:** người **HỌC LUẬT, hành nghề LUẬT** — **THẨM
PHÁN, TRẠNG SƯ (LUẬT SƯ), công chứng viên, kiểm soát viên**.

Tư duy **sắc bén, giỏi lập luận**, công việc **tỉ mỉ, cẩn trọng, khắt khe**.

Công việc yêu cầu khả năng **soi xét, phán đoán, suy luận**, tính khắt khe
cao.

Công việc có **tính cạnh tranh** và **hay bị cạnh tranh** trong nghề nghiệp.

Công việc **dễ vướng PHÁP LUẬT, KIỆN TỤNG, KHỞI TỐ**: cần **hết sức cẩn
thận**, dễ bị **"đâm sau lưng"**, cạnh tranh không lành mạnh.`,
  },

  {
    ...
    cung: ['Nô Bộc'],
    doUuTien: 70,
    tomTat: `**Quan Phủ cư Nô (KHÔNG cát tinh):** dễ bị bạn bè, đồng nghiệp
**GHEN GHÉT, CHƠI XẤU, THƯA KIỆN**.

Quan hệ đi kèm **đề phòng, xét nét, thiếu hài hòa**:
...
đề pháp luật**.`,
...

  {
    ...
    cung: ['Thiên Di'],
    doUuTien: 72,
    tomTat: `**Quan Phủ cư Di:** ra ngoài dễ **dính THỊ PHI, KIỆN TỤNG** —
...
- Có **TÍN NHIỆM cao**, được tin tưởng giao việc quan trọng bên ngoài.`,
...

  {
    ...
    cung: ['Tật Ách'],
    doUuTien: 75,
    tomTat: `**Quan Phủ cư Tật:** mối nguy tiềm ẩn từ **PHÁP LÝ, KIỆN TỤNG,
...
nhẹ — nhờ **HIỂU BIẾT để thoát hiểm**, **chuyển bại thành thắng**.`,
  },
  {
    ...
    doUuTien: 70,
    tomTat: `**Quan Phủ + Thái Tuế / Hóa Kỵ / Liêm Trinh / Bạch Hổ / Thiên Hình
tại Tật Ách:** nguy cơ rơi vào **VÒNG LAO LÝ, TÙ TỘI** càng tăng.`,
  },
  {
    ...
    ketHop: ['Thái Tuế'],
    doUuTien: 70,
    tomTat: `**Quan Phủ + Thái Tuế tại Tật Ách:** "**SUỐT ĐỜI MÒN MÒN NGỒI CỬA
CÔNG MÔN**" — cuộc đời gắn liền với tòa án.`,
...

  {
    ...
    cung: ['Tài Bạch'],
    doUuTien: 75,
    tomTat: `**Quan Phủ cư Tài:** người **CẨN TRỌNG, NGUYÊN TẮC** trong tiền
nong — chi tiêu **có kiểm soát**, đòi hỏi **MINH BẠCH, RÕ RÀNG**.
...
Người **kiếm tiền nghề KIỆN** (luật sư, hộ giá viên) hoặc đi cạnh tranh,
kiện tụng người khác để mình có tiền.`,
  },
  {
    ...
    doUuTien: 70,
    tomTat: `**Quan Phủ + Hung sát (Kình / Đà / Hỏa / Linh / Không / Kiếp) tại
...
(lường gạt).`,
...

  {
    ...
    cung: ['Tử Tức'],
    doUuTien: 72,
    tomTat: `**Quan Phủ cư Tử Tức + Cát tinh:** con cái **THÔNG MINH, TƯ DUY
SẮC BÉN, suy xét tốt** — dễ làm **NGHỀ THẨM PHÁN, ngành luật**, các lĩnh vực
đòi hỏi óc phân tích.

Nếu **cung Phối cũng xấu:** có thể **TRANH GIÀNH QUYỀN NUÔI CON** giữa hai
vợ chồng (khi ly hôn).`,
  },
  {
...
có thể **TRANH TỤNG với con**.`,
...

  {
    ...
    cung: ['Phu Thê'],
    doUuTien: 75,
    tomTat: `**Quan Phủ cư Phu Thê:** đời sống hôn nhân **THIÊN VỀ LÝ TRÍ**,
ít tình cảm.

Người hôn phối:
- **NGUYÊN TẮC, GIỎI LÝ LUẬN**
- Có thể làm trong **ngành PHÁP LUẬT, hình pháp**

Vì tính cách **quá rạch ròi và xét nét**: vợ chồng:
...
nơi hai người **ĐỆ ĐƠN LY DỊ**.`,
...

  {
    ...
    cung: ['Huynh Đệ'],
    doUuTien: 70,
    tomTat: `**Quan Phủ cư Huynh Đệ:** anh chị em **dễ BẤT HÒA, tranh giành
của cải mà KIỆN TỤNG nhau**.

Mỗi người có **tư duy riêng**, ít chịu nhường nhịn: tranh cãi:
- **Phân chia TÀI SẢN THỪA KẾ**
- **Đất đai tổ tiên**
- **Trách nhiệm phụng dưỡng cha mẹ**

**Có người làm LUẬT SƯ / THẨM PHÁN**: mâu thuẫn được **HÒA GIẢI**, giảm
tranh chấp nội bộ: **rất tốt**.`,
  },

  {
    ...
    doUuTien: 65,
    tomTat: `**Quan Phủ + Thái Tuế + Đà La + Hóa Kỵ:** chủ về **THỊ PHI, KIỆN
CÁO**, làm **mất ăn mất ngủ** vì **cạnh tranh hơn thiệt**.

- Mâu thuẫn cũ được khơi mào: biến cố pháp lý: **kiện tụng dai dẳng**.

- Lời nói thành gươm giáo, **một hành động nhỏ: hậu quả lớn về pháp lý**.`,
  },

  {
    ...
    doUuTien: 65,
    tomTat: `**Quan Phủ + Thiên Hình + Địa Không + Địa Kiếp:** thế cục của
**OAN TRÁI và ÂN OÁN cá nhân**.
...
- Vướng vào **vòng xoáy trả thù**.`,
...

  {
    ...
    doUuTien: 65,
    tomTat: `**Quan Phủ + Thất Sát + Bạch Hổ + Thiên Hình:** chủ về **TÙ TỘI,
ÁN PHẠT**.
...
- Cách cục **CỰC HUNG** — cần đặc biệt thận trọng.`,
...

  {
    ...
    doUuTien: 70,
    tomTat: `**Quan Phủ + Liêm Trinh + Tang Môn + Bạch Hổ** = cách **"HÌNH
NGỤC NAN ĐÀO"** — **CẢNH LAO LÝ KHÓ TRÁNH**.
...
Một trong những cách cục cảnh báo **nguy hiểm NHẤT** liên quan đến pháp
lý trong tử vi — cần kiểm tra cẩn thận khi luận giải.`,
  },

  {
    ...
    sao: ['Quan Phủ'],
    doUuTien: 50,
    tomTat: `**Hạn có Quan Phủ** (đặc biệt + **Thái Tuế / Đà La / Hóa Kỵ**):
vận trình rơi vào **VÒNG XOÁY TRANH CHẤP, KIỆN TỤNG DAI DẲNG**.

- Đây là thời điểm:
- **Mâu thuẫn cũ ĐƯỢC KHƠI MÀO**
- Điều tưởng đã lắng xuống **TRỖI DẬY** thành **biến cố pháp lý**

Sức ảnh hưởng có thể biến **lời nói thành gươm giáo** — chỉ một hành động
nhỏ cũng dẫn đến **hậu quả LỚN về pháp lý**.

**Lời khuyên hạn:**
- **Cẩn trọng KÝ KẾT giấy tờ, hợp đồng**
