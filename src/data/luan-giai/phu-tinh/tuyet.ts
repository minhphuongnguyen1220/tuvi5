...
⚡ **Vai trò 2 mặt:**
- ⚠️ Bản thân là **HUNG TINH** chủ về bế tắc, suy tàn
- ✅ Đặc biệt: **KÌM HÃM** sức phá hoại của **SÁT TINH** đồng cung
  → tai họa chỉ dừng ở mức **SUY TÍNH**, chưa phát tác thành hiện thực
...
- Sống **NỘI TÂM**, thiên về **TOAN TÍNH** hơn hành động bộc phát`,
...

  {
    ...
    ketHop: ['Thiên Mã'],
    doUuTien: 60,
    tomTat: `⚠️ **Tuyệt + Thiên Mã + Tuần / Triệt** — như "**NGỰA CÙNG ĐƯỜNG**".
...
xe gặp đường tuyệt + chặn — cảnh ngộ tuyệt vọng.`,
...

  {
    ...
    doUuTien: 60,
    tomTat: `⚠️ **Tuyệt + Thất Sát + Phá Quân + Tham Lang** — vận số tiềm ẩn **HIỂM HỌA
BẤT NGỜ**.
...
⚠️ **Hội Tuần / Triệt hoặc nhiều sát bại tinh:**
...
⚠️ **Hội Địa Không, Địa Kiếp, Kình Đà:**
...
⚠️ **Mặt trái - tính ẩn kín:**
- Vì **ẨN KÍN** nên **KHÓ CHẨN ĐOÁN**
- Dễ **KÉO DÀI**
- Gây **HAO MÒN SỨC KHỎE**

⚠️ **Hội nhiều sát bại tinh** (Không Kiếp, Kình Đà, Linh Hỏa):
- Bệnh càng **NGUY HIỂM**
...
⚠️ **Hội sát bại tinh** (Kình Đà, Linh Hỏa):
