...
⚠️ **Nguy hiểm:** có khả năng được **bổ nhiệm chức vụ quan trọng**, nhưng chưa
kịp **phát huy năng lực** đã bị **GIÁNG CHỨC, CÁCH CHỨC** hoặc **MẤT VIỆC**.

⚠️ Thậm chí còn có tình huống bị **VU OAN**, bị người khác **GIÈM PHA, NÓI XẤU**.
