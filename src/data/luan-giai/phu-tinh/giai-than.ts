...
- Đây là điểm khác biệt quan trọng với các sao Giải khác`,
...

  {
    ...
    sao: ['Giải Thần'],
    doUuTien: 60,
    tomTat: `⚠️ **CẢNH BÁO ĐẶC BIỆT** — Giải Thần có MẶT TỐI ít người biết.
...
⚡ **Tướng mạo:**
- **NHAN SẮC ĐẸP**, da mặt **HỒNG HÀO, THANH TÚ** (đặc biệt phụ nữ)
- Mặt mũi **THANH THOÁT, NHẸ NHÀNG**
- Dễ làm mọi người **THOẢI MÁI** khi tiếp xúc
- Nữ: sắc diện đẹp **NHẸ NHÀNG, NHU THUẬN** nhưng đầy sức hút
- Nam: **ĐĨNH ĐẠC, VỮNG VÀNG**, dễ đặt niềm tin
...
⚠️ **Lưu ý:** Giải Thần cư Phúc Đức cũng **GIẢI BỚT PHÚC ĐỨC** (đặc tính
...
⚠️ **Sát tinh hội (Không Kiếp, Kình Đà, Hóa Kỵ):**
...
⚠️ **Lưu ý:** Cần xem trong cung có đi kèm **HUNG TINH** không để biết
...
⚠️ **Sát tinh hội (Địa Kiếp, Không Kiếp):**
