...
**PHÂN BIỆT với CUNG Phúc Đức** — đây là **SAO**, có thể đóng tại bất kỳ
...
- **GIẢM NHẸ** hoặc **HÓA GIẢI** tai họa nhỏ, bệnh tật, thị phi`,
...

  {
    ...
    doUuTien: 75,
    tomTat: `**Sao Phúc Đức Mệnh + Thiên Đức + Thiên Quan / Thiên Phúc / Giải Thần / Thiên Giải / Địa Giải / Quang Quý / Tả Hữu / Thiếu Dương / Thiếu Âm:**
...
- Nhờ **PHÚC ẤM của cha mẹ**: dễ được **GIÚP ĐỠ lúc khó khăn**, tránh **nhiều tai ương**`,
  },

  {
    ...
    doUuTien: 73,
    tomTat: `**Sao Phúc Đức Phụ Mẫu + Thiên Đức / Thiên Phúc / Quang Quý / Thiên Quan:**
...
- Con cái **HIỂN ĐẠT**`,
...

  {
    ...
    doUuTien: 73,
    tomTat: `**Sao Phúc Đức Phụ Mẫu + Không / Kiếp / Hình / Kỵ:**
- Phúc phần **SUY GIẢM**
- Cha mẹ phải trải qua **BỆNH TẬT, TRẮC TRỞ**
- Nhờ **tính chất CỨU GIẢI** của Phúc Đức nên tai họa thường được **HÓA GIẢI**, khó thành điều dữ`,
  },
...
- Con cháu được hưởng **MAY MẮN, BÌNH AN**, nhiều người **THÀNH ĐẠT**`,
...

  {
    ...
    doUuTien: 80,
    tomTat: `**Sao Phúc Đức + Thiên Đức + Nguyệt Đức đồng cung Phúc Đức:** **CÁCH ĐẸP NHẤT**.
- Họ hàng **PHÚC HẬU**
- Mồ mả **THUẬN VỊ**
- Dòng họ có nhiều người **TRỌNG NGHĨA, hay GIÚP NGƯỜI**
- Gặp **CHUYỆN NGUY NAN** thường có **QUÝ NHÂN TƯƠNG TRỢ** hoặc được **HÓA GIẢI**`,
  },

  {
    ...
    doUuTien: 78,
    tomTat: `**Sao Phúc Đức Phúc Đức + Quang Quý / Thiên Quan / Thiên Phúc:** phúc đức càng **LỚN**.
...
- Con cái càng **HIỂN ĐẠT**, có **ĐẠO ĐỨC** và gặp **NHIỀU MAY MẮN**`,
...

  {
    ...
    doUuTien: 73,
    tomTat: `**Sao Phúc Đức Tử Tức + Thiên Đồng + Nguyệt Đức:**
- Vợ chồng có **CON SỚM**
...
- Đôi bên **TÔN TRỌNG và CẢM THÔNG** cho nhau`,
...

  {
    ...
    ketHop: ['Thiên Đức', 'Nguyệt Đức'],
    doUuTien: 73,
    tomTat: `**Sao Phúc Đức Phu Thê + Thiên Đức + Nguyệt Đức:** tình cảm vợ chồng càng **BỀN CHẶT**:
...
- Biết **CÙNG NHAU VUN VÉN, vượt qua khó khăn**`,
...

  {
    ...
    ketHop: ['Đào Hoa'],
    doUuTien: 73,
    tomTat: `**Sao Phúc Đức Phu Thê + Đào Hoa:** vợ chồng **HÒA HỢP** về tâm tính, **XỨNG ĐÔI về dung mạo**, yêu thương gắn bó, có **DUYÊN NỢ SÂU DÀY**.`,
  },
...
- **KẾT NỐI TÌNH CẢM**`,
...

  {
    ...
    doUuTien: 60,
    tomTat: `**Sao Phúc Đức hạn + Nguyệt Đức + Đào Hoa + Hồng Loan:** điềm lành về **NHÂN DUYÊN**:
- Dễ **GẶP NGƯỜI KHÁC PHÁI** tốt bụng, hiền hậu
- Thậm chí được **NGƯỜI LÀM MAI MỐI** để nên **DUYÊN VỢ CHỒNG**
- Mối quan hệ tình cảm **THUẬN LỢI**, có **DUYÊN TRỜI ĐỊNH**, dễ kết thành đôi lứa chính thức`,
  },
