...
chứ không mơ mộng hão huyền. ⚠️ Đôi khi tham vọng quá mức → **cố chấp**, sẵn sàng
...
→ Đặc biệt bất lợi cho nữ mệnh — gây **trắc trở duyên nợ**.`,
  ...
  // ============================================================
  {
    ...
    title: 'Vũ Khúc tại Mệnh - Tướng mạo',
    sao: ['Vũ Khúc'],
    cung: ['Mệnh'],
    doUuTien: 80,
    tomTat: `**Vũ Khúc cư Mệnh:**

- **Đắc địa:** thân hình **nở nang cao vừa tầm, nặng cân**, đầu và mặt dài, vẻ
  mặt **uy nghi**, tiếng nói to, có **nốt ruồi ở chỗ kín**
- **Hãm địa:** **bé nhỏ, thấp, hơi đen**, có nhiều ngấn vết, **tóc rậm và xấu**
- **Đặc trưng chung:** vóc dáng **nhỏ nhắn dong dỏng, đầu to thân nhỏ**, giọng
  vang thanh thoát, tác phong **nhanh nhẹn hoạt bát** nhưng vẫn có **nét lãnh
  đạm, kín kẽ**`,
  },
  ...
  // ============================================================
  {
    ...
    title: 'Vũ Khúc tại Mệnh - Tính cách',
    sao: ['Vũ Khúc'],
    cung: ['Mệnh'],
    doUuTien: 85,
    tomTat: `Người **Vũ Khúc cư Mệnh:**

- **Đắc địa:** **thông minh, có chí lớn**, có **óc kinh doanh, tài buôn bán**.
  Tính tình **mạnh bạo, quả quyết, cương nghị, thẳng thắn, hiếu thắng**
- **Hãm địa:** **kém thông minh**, tham lận, **thiếu lương thiện, hà tiện, bủn
  xỉn, ương ngạnh**
- Đặc trưng: **ngay thẳng, kiên định**, giải quyết nhanh, **chăm chỉ, ý chí bền
  bỉ**, cô độc ít nói, **không thích giao du nơi đông người**`,
...
- **Quyết tâm lớn** để theo đuổi mục tiêu`,
  ...
  // ============================================================
  {
    ...
    title: 'Vũ Khúc tại Mệnh - Sự nghiệp & tài lộc',
    sao: ['Vũ Khúc'],
    cung: ['Mệnh'],
    doUuTien: 82,
...
**Đắc địa:** **suốt đời giàu sang**, tiền bạc dư dả, được nắm giữ tiền bạc, có
**uy danh lừng lẫy, sự nghiệp lớn lao**.

**Hãm địa:** **bất đắc chí**, công danh trắc trở, tiền bạc khó kiếm, **phá tán
tổ nghiệp**, phải **ly hương tự lập**, không nhờ được người thân.`,
...
Lúc thiếu thời thì **no ấm**, nhưng **chẳng mấy khi xứng ý toại lòng** về công
danh tiền bạc. **Sau 30 tuổi mới tốt**, càng về già càng tốt.
...
⚠️ **TÍNH CÔ ĐỘC** đặc biệt bất lợi cho nữ mệnh:
...
⚠️ Nữ mệnh Vũ Phủ Tý/Ngọ + Hóa Kỵ: **hôn nhân đứt đoạn / sinh ly**, không hạnh
phúc đến già.`,
  },
...
⚠️ **Vũ Khúc Hóa Kỵ** đồng độ → tính chất Thiên Tướng biến **xấu**, chỉ hợp
...
⚠️ Nữ mệnh Vũ Tham Sửu/Mùi + Hóa Kỵ: cảnh báo **bạn đời phá gia, hao tài**.`,
  },
...
⚠️ Bệnh Tật Ách: bệnh **bộ máy tiêu hóa**.
⚠️ Tử Tức: **khó có con / sinh con muộn**, con cái **chơi bời phá tán** hoặc
**khắc khẩu với cha mẹ**.`,
  },
  ...
  // ============================================================
  {
    ...
    title: '⚠️ Vũ Phá cư Mệnh tại Tỵ / Hợi - Cách XẤU',
    sao: ['Vũ Khúc', 'Phá Quân'],
    cung: ['Mệnh'],
    chi: ['Tỵ', 'Hợi'],
    ketHop: ['Vũ Phá', 'Vũ Khúc Phá Quân đồng cung'],
    doUuTien: 90,
    tomTat: `⚠️ **Vũ Khúc + Phá Quân đồng cung tại Tỵ / Hợi** = cách **"Vũ Phá"**
...
**Cung Phu Thê Thìn/Tuất:** nên **lập gia đình muộn** hoặc lấy người **bằng tuổi**
để được hưởng **giàu sang nhờ đối tượng**.

**Cung Huynh Đệ Thìn/Tuất + cát tinh:** anh em **hòa hợp**, dù ít trợ giúp nhưng
**tình cảm gắn bó**.`,
  },
...
cha mẹ **khó sống với nhau đến già**.`,
  ...
  // ============================================================
  {
    ...
    title: 'Vũ Khúc tại Phúc Đức',
    sao: ['Vũ Khúc'],
    cung: ['Phúc Đức'],
    doUuTien: 78,
    tomTat: `**Vũ Khúc tại Phúc Đức:**

- **Miếu / Vượng:** dòng họ có nhiều người **kinh doanh giàu có**, cuộc sống
  thuận lợi
- **Hãm địa:** **hao tổn tinh thần**, dễ phải suy nghĩ lo lắng
...
ngoãn**, chủ **2 con**.`,
  ...
  // ============================================================
  {
    ...
    cung: ['Phu Thê'],
    doUuTien: 85,
    tomTat: `⚠️ **Cung Phu Thê là vị trí BẤT LỢI NHẤT của Vũ Khúc** — cho thấy
