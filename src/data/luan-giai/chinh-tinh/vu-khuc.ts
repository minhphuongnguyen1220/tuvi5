...
ruồi ở chỗ kín**.`,
...

  {
    ...
    trangThai: ['Hãm'],
    doUuTien: 80,
    tomTat: `⚠️ **Vũ Khúc Hãm địa tại Mệnh:** **bé nhỏ, thấp, hơi đen**, có nhiều
...
thẳng thắn, hiếu thắng**.`,
...

  {
    ...
    trangThai: ['Hãm'],
    doUuTien: 85,
    tomTat: `⚠️ **Vũ Khúc Hãm địa tại Mệnh:** **kém thông minh**, tham lận, **thiếu
...
bạc dư dả, được nắm giữ tiền bạc, có **uy danh lừng lẫy, sự nghiệp lớn lao**.`,
...

  {
    ...
    trangThai: ['Hãm'],
    doUuTien: 85,
    tomTat: `⚠️ **Vũ Khúc Hãm địa tại Mệnh:** **bất đắc chí**, công danh trắc trở,
...
Phù hợp: **buôn bán, kinh doanh, công kỹ nghệ, pha chế chế biến**.`,
...

  {
    ...
    doUuTien: 88,
    tomTat: `⚠️ **Nữ mệnh — Vũ Phủ Tý/Ngọ + Hóa Kỵ:** **hôn nhân đứt đoạn / sinh
...
**phát triển nhanh chóng**, hậu vận **có của ăn của để**.`,
...

  {
    ...
    doUuTien: 88,
    tomTat: `⚠️ **Nữ mệnh — Vũ Tham Sửu/Mùi + Hóa Kỵ:** cảnh báo **bạn đời phá
gia, hao tài**.`,
  },
...
doanh giàu có**, cuộc sống thuận lợi.`,
...

  {
    ...
    trangThai: ['Hãm'],
    doUuTien: 76,
    tomTat: `⚠️ **Vũ Khúc Hãm địa tại Phúc Đức:** **hao tổn tinh thần**, dễ phải
suy nghĩ lo lắng.`,
  },
...
Kim): ra ngoài **buôn bán làm giàu rất dễ dàng**.`,
...

  {
    ...
    trangThai: ['Hãm'],
    doUuTien: 80,
    tomTat: `⚠️ **Vũ Khúc Hãm địa tại Thiên Di** (mệnh khắc): **tiểu thương**, khó
kiếm tiền.`,
  },
...
huyết**.`,
...

  {
    ...
    chi: ['Dậu'],
    doUuTien: 80,
    tomTat: `⚠️ **Vũ Khúc tại Tật Ách ở Dậu:** **nội thương khó chữa**.`,
  },
