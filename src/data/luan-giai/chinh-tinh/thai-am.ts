...
Thái Âm cùng các sát tinh đồng cung hoặc gia hội tạo thành tổ hợp **bất lợi**:
- **Cự Môn**
- **Kình Dương**
- **Liêm Trinh**
- **Thất Sát**
...
Thái Âm rơi vào hãm địa, lại gặp sát tinh:
...
**Đặc biệt vất vả khi rơi vào 4 cung Mã** (Dần, Thân, Tỵ, Hợi).

**Đồng cung Thiên Cơ**: mang tính **lưu động**, dễ **lưu lạc tha hương**,
...
- Lại gặp cát tinh`,
  ...
  // ============================================================
  {
    ...
    sao: ['Thái Âm'],
    doUuTien: 65,
    tomTat: `**"Nhật Nguyệt Phản Bội":** 2 trường hợp:
...
**mệnh vất vả lao lực**.`,
  ...
  // ============================================================
  {
    ...
    chi: ['Ngọ'],
    doUuTien: 75,
    tomTat: `**"Nguyệt Đồng Ngộ Sát":** Thái Âm + Thiên Đồng **lạc hãm tại
...
Cách "Nguyệt Đồng Ngộ Sát" — chủ về **mọi việc đều không thuận lợi**.`,
  ...
  // ============================================================
  {
    ...
    cung: ['Tật Ách'],
    doUuTien: 85,
    tomTat: `**"Nhật Nguyệt Tật Ách":** Thái Dương + Thái Âm **lạc hãm**, trấn
thủ cung **Tật Ách**.
...
Cách "Nhật Nguyệt Tật Ách" — chủ về **cơ thể có khuyết tật**.`,
  ...
  // ============================================================
  {
    ...
    chi: ['Thìn'],
    doUuTien: 75,
    tomTat: `**"Thiên Lương Củng Nguyệt":** Thái Âm tại **Thìn**, Thiên Lương
...
- Chi tiêu **khá thoáng tay**`,
...

  {
    ...
    trangThai: ['Hãm'],
    doUuTien: 78,
    tomTat: `**Thái Âm Hãm tại Mệnh:** ưu điểm dễ biến thành **buông thả, ham
...
**Hãm địa:** tiền vận vất vả, phải **nương nhờ hoặc đi đường vòng**. Trung
...
**Duyên ngầm:** Thái Âm + **Đào Hoa, Hồng Loan, Thiên Riêu**: đường tình
...
Nhưng cũng tiềm ẩn nguy cơ **đa tình** — không tiết chế sẽ sinh rắc rối về
tình duyên.`,
  },
...
**Mệnh Thái Âm bị ám tinh xâm phạm** (Đà La, Hóa Kỵ, Không Kiếp) hoặc bị
...
Khi Mệnh Thái Âm bị **ám tinh xâm phạm**:
- **Đà La**
- **Hóa Kỵ**
...
- **Suy giảm thị giác**`,
...

  {
    ...
    gioiTinh: 'Nữ',
    doUuTien: 70,
    tomTat: `**Nữ mệnh — Thái Âm tại Mệnh:** liên quan đến **khí huyết, phụ
...
**Thái Âm hãm địa:** kiếm tiền vẫn được nhưng vất vả hơn, **tiền vào rồi
...
**Ngọ (hãm):** cuộc đời nhiều bế tắc, tiền vận vất vả, tâm lý bất ổn, dễ thị
...
**Dần (mọc/lặn):** **bôn ba, ly hương**, ít ổn định. Cần nhiều cát tinh nâng
đỡ.
...
**Tuy nhiên** do ảnh hưởng của Thiên Cơ:
...
- Nếu không tiết chế sẽ **tự tạo áp lực** cho bản thân`,
...

  {
    ...
    gioiTinh: 'Nữ',
    doUuTien: 80,
    tomTat: `**Nữ mệnh — Thái Âm tại cung Dần:** vị trí **khá kỵ** với nữ mệnh
— dễ **đa sầu đa cảm**, **tình duyên trắc trở**, tâm lý hay **bất an**.`,
  ...
  // ============================================================
  {
    ...
    chi: ['Mão', 'Dậu'],
    doUuTien: 88,
    tomTat: `**Mão (hãm):** trăng lúc bình minh, ánh sáng yếu: công danh đến
...
lộc dồi dào, nhân cách đức độ, **địa vị cao, sống lâu**, hưởng phúc hậu vận.`,
    ...
    chiTiet: `## Thái Âm cung Mệnh cư Mão (hãm địa)
...
**Thìn (hãm):** cuộc đời **vất vả, nghèo khó**, dễ phải **ly tổ lập nghiệp**,
...
**Tuy nhiên,** cách **"Nhật Nguyệt Tranh Huy"** cũng khiến cuộc đời:
- Dễ gặp **sự ganh ghét**
...
- Hoặc bị **bó buộc bởi trách nhiệm và danh tiếng**`,
  ...
  // ============================================================
  {
    ...
    chi: ['Tỵ', 'Hợi'],
    doUuTien: 88,
    tomTat: `**Tỵ (hãm):** số phận nhiều thăng trầm, tâm lý yếu, cuộc sống
...
mắn**, dễ thành công.`,
...

  {
    ...
    trangThai: ['Hãm'],
    doUuTien: 75,
    tomTat: `**Thái Âm Hãm tại Quan Lộc:** sự nghiệp **biến động**, **khó
tích lũy tài sản**.`,
  },
...
Thái Âm ở cung Phụ Mẫu **không nên ở vị trí Hãm địa**.`,
...

  {
    ...
    trangThai: ['Hãm'],
    doUuTien: 78,
    tomTat: `**Thái Âm Lạc Hãm tại Phụ Mẫu:** bất lợi ở **mẹ** — **nhẹ:** cô
...
**Hóa Kỵ:** bị liên lụy: **phá tài, thất bại vì bạn bè hoặc cấp dưới**.`,
...
- **Thuận lợi về nuôi dạy con cái**`,
...

  {
    ...
    trangThai: ['Hãm'],
    doUuTien: 75,
    tomTat: `**Thái Âm Lạc Hãm tại Tử Tức:** con cái có phần **nhu nhược,
hướng nội** hơn.`,
  },
...
- **Khó ổn định tại một nơi**`,
...

  {
    ...
    doUuTien: 80,
    tomTat: `**Thái Âm Lạc Hãm + sát tinh tại Điền Trạch:** ở nơi **đông đúc,
ồn ào**.`,
  },
...
già**.`,
...

  {
    ...
    trangThai: ['Hãm'],
    doUuTien: 75,
    tomTat: `**Thái Âm Hãm địa tại Phúc Đức:** **năng lực cạnh tranh không mạnh**.`,
  },

  {
    ...
    doUuTien: 80,
    tomTat: `**Thái Âm Miếu địa + Địa Không + Địa Kiếp tại Phúc Đức:** sẽ thành
**vô tâm**.`,
  },
