...
**Kình Dương + Đà La** kích hoạt mặt tối của Tham Lang tọa Mệnh:
...
- Dễ vì **tình hoặc tiền** mà sinh **tranh chấp, oán hận**`,
...

  {
    ...
    doUuTien: 45,
    tomTat: `**Tham Lang + Kình Dương + Đà La đồng độ:** kích hoạt mặt tối của
Tham Lang, dễ dẫn đến **sa đọa vì sắc, rượu, cờ bạc**.`,
...

  {
    ...
    doUuTien: 45,
    tomTat: `**Tham Lang + Địa Không + Địa Kiếp:** tham vọng trở nên **viển
...
**Gặp Tuần:** dễ sinh **khoác lác**, **nói nhiều làm ít**.`,
...

  {
    ...
    ketHop: ['Hóa Kỵ'],
    doUuTien: 45,
    tomTat: `**Tham Lang + Hóa Kỵ:** làm tăng tính **ghen tuông, đố kỵ**, dễ
...
**Thiếu sao ổn định / không tu dưỡng:** thành công khó bền — **dễ đến rồi
dễ mất**.`,
...
- **Dễ đến rồi lại dễ mất**`,
  ...
  // ============================================================
  {
    ...
    cung: ['Mệnh'],
    doUuTien: 75,
    tomTat: `**Tham Lang tại Mệnh — hôn nhân nhiều sóng gió** (đặc biệt **tiền
...
**Tuy nhiên** — do khuynh hướng **ham hưởng thụ**, cần đặc biệt lưu tâm:
...
**Bản tính tiêu xài phóng khoáng + thích hưởng thụ**: tiền bạc **"vào
nhanh ra nhanh"**.
...
- **Kiểm soát ham muốn cá nhân**`,
  ...
  // ============================================================
  {
    ...
    chi: ['Tý', 'Ngọ'],
    doUuTien: 88,
    tomTat: `**Tham Lang tại Tý — HÃM ĐỊA**, cách **"PHIẾM THỦY ĐÀO HOA"**:
...
**Tham Lang an Mệnh tại Tý rơi vào hãm địa** — còn gọi là cách **"Phiếm
...
Tuy nhiên, do ảnh hưởng của **Vũ Khúc cô độc** — cuộc sống **nội tâm cô
đơn, ít tri kỷ**.`,
...
**Tại Thân:** cuộc đời **nhiều tranh luận, thị phi** — thành công đến từ
sự **phấn đấu bền bỉ**.`,
...
Khi giải đoán lá số bói mệnh, vị trí Thân tiết lộ:
...
**Hội hung tinh:** sa đà **cám dỗ**, **chán nản đời sống thế tục**: có
...
Tuy nhiên, con đường đi đến thành công phải trải qua **nhiều biến cố và
thử thách**.`,
...
- **Nhiều thử thách**`,
  ...
  // ============================================================
  {
    ...
    ketHop: ['Liêm Trinh'],
    doUuTien: 88,
    tomTat: `**Tham Lang tại Tỵ / Hợi — HÃM ĐỊA**, đồng cung **Liêm Trinh**
...
có**.`,
...

  {
    ...
    ketHop: ['Hóa Kỵ'],
    doUuTien: 75,
    tomTat: `**Tham Lang Hóa Kỵ tại Tài Bạch:** kiếm tiền dễ vướng **thị phi,
tranh chấp tiền bạc**.`,
  },

  {
    ...
    ketHop: ['Liêm Trinh'],
    doUuTien: 75,
    tomTat: `**Tham Lang tại Tài Bạch + Liêm Trinh:** sẽ phải **vất vả** trong
vấn đề tài chính.`,
  },
...
tốt**.`,
...

  {
    ...
    trangThai: ['Hãm'],
    doUuTien: 78,
    tomTat: `**Tham Lang HÃM tại Phụ Mẫu:** hôn nhân cha mẹ **không bền chặt,
dễ ly biệt**.`,
  },
...
nhân**. Nên **kết hôn muộn**.`,
...

  {
    ...
    gioiTinh: 'Nam',
    doUuTien: 78,
    tomTat: `**Nam mệnh — Tham Lang HÃM tại Phu Thê:** nên lấy **vợ lớn tuổi
hơn mình**.`,
  },

  {
    ...
    gioiTinh: 'Nữ',
    doUuTien: 78,
    tomTat: `**Nữ mệnh — Tham Lang HÃM tại Phu Thê:** cần lấy chồng **xứng
đôi** mới tránh sự cố.`,
  },
...
con cái **tài hoa, ngoan ngoãn**.`,
...

  {
    ...
    doUuTien: 70,
    tomTat: `**Tham Lang tại Tử Tức + Sát / Kỵ:** chủ về **cha con bất hòa**,
...
có **hậu vận**, họ hàng cũng được **vinh hoa phú quý**.`,
...

  {
    ...
    doUuTien: 78,
    tomTat: `**Tham Lang HÃM tại Phúc Đức + Đào Hoa / Hồng Loan:** cuộc đời
...
**Không có sao tốt:** người dưới quyền **không nhờ cậy được**, dễ có lòng
...
- **Anh em đông**`,
  },
  {
    ...
    ketHop: ['Đào Hoa'],
    doUuTien: 75,
    tomTat: `**Tham Lang + Đào Hoa đồng hội tại Huynh Đệ:** chị em gái dễ **vất
vả đường tình duyên**.`,
  },
