...
⚠️ **Tử Vi cần quần thần phò tá:** một vị vua đơn độc không có người phò tá
(thiếu Tả Phụ, Hữu Bật) sẽ trở thành **"cô quân"** — nắm quyền nhưng đơn độc,
...
Khi Tử Vi được hội tụ đầy đủ **Tả Phụ + Hữu Bật + Thiên Khôi + Thiên Việt**
...
- **Nam:** khí khái oai nghiêm, năng lực lãnh đạo tập thể
- **Nữ:** mặt mày thanh tú, dáng vẻ đoan trang nền nã, biết lo toan, hợp hình
  mẫu **"vợ hiền mẹ đảm"**

Cả nam và nữ đều có nét **thông minh, có chí hướng, dễ gặp quý nhân nâng đỡ**.`,
  },
  ...
  // ============================================================
  {
    ...
    title: 'Tử Vi tại Mệnh - Tính cách theo vị trí',
    sao: ['Tử Vi'],
    cung: ['Mệnh'],
    doUuTien: 80,
    tomTat: `**Tính cách Tử Vi cư Mệnh thay đổi theo vị trí:**

- **Miếu địa (Dần, Thân, Ngọ):** **TÔN QUÝ** — uy nghi, nghiêm cẩn, trung hậu,
  thông minh, làm việc có trách nhiệm. **Lãnh đạo khiến người khác tâm phục
  khẩu phục**, chỉ huy tập thể, đạt thành công lớn
- **Vượng địa (Thìn, Tuất):** **GIÀU SANG** — tài trí mưu lược, oai phong, **giỏi
  kinh doanh, quản lý tài chính tốt** → cuộc sống giàu sang thịnh vượng
- **Đắc địa (Sửu, Mùi):** **PHÚC THỌ** — thông minh, liều lĩnh, thao lược, có
  thiện tâm, **biết hy sinh, suy nghĩ cho mọi người** → phúc thọ cao hơn người
- **Bình hòa (Tý, Mão, Dậu, Hợi):** **TỐ CHẤT TỐT** — nhân hậu, hiền lành, có tư
  tưởng lớn, nhiều người có **tín ngưỡng mạnh, bước vào con đường tu hành**`,
...
Khi Mệnh có Tử Vi → cung **Phu Thê có bộ Sát Phá Tham** → đương số có xu hướng
**nhường nhịn người bạn đời**, đặc biệt khi về nhà mọi việc đều bỏ lại phía sau,
**hơi nể vợ/chồng**.`,
  },
...
⚠️ **"Vật cực tất phản":** quá cầu toàn → chịu thiệt thòi; quyền lực thể hiện
...
vừa là điểm yếu (chịu thiệt thòi cá nhân).`,
  ...
  {
    id: 'tu-vi-co-quan',
    title: '⚠️ "Cô Quân" - Tử Vi đứng một mình thiếu Tả Hữu',
    sao: ['Tử Vi'],
    cung: ['Mệnh'],
    doUuTien: 70,
    tomTat: `⚠️ **Cách "CÔ QUÂN":** Tử Vi đứng một mình mà **không có cát tinh**,
đặc biệt **thiếu Tả Phụ + Hữu Bật** → rơi vào thế cô độc.
...
→ **Lời khuyên:** đoán Tử Vi tại Mệnh phải tìm Tả Phụ, Hữu Bật, Thiên Khôi,
...
- **Tả Phụ + Hữu Bật:** quyền lực được củng cố qua giúp đỡ thực tế
...
- **Hóa Khoa:** danh tiếng, học vấn, được công nhận`,
  ...
  // ============================================================
  {
    ...
    sao: ['Tử Vi'],
    doUuTien: 50,
    tomTat: `⚠️ **Tử Vi gặp hung sát tinh → biến thành "Bạo Quân" hoặc "Cô Quân":**
...
⚠️ Có mâu thuẫn nội tại: Tử Vi muốn **khai phá**, Thiên Phủ lại **bảo thủ ổn
...
## Cũng tạo ở Tỵ / Hợi (cung Sinh)

Khi Tử Vi và Thiên Phủ nằm tại **Tỵ / Hợi hội chiếu cung Mệnh** cũng tính là
**Tử Phủ đồng cung** — cùng chủ về một đời giàu có.`,
  },
...
⚠️ Vị trí nằm trong **Thiên La - Địa Võng**, đối diện **Phá Quân** → nội tâm
...
- **Thông minh, chững chạc, bản lĩnh**, không kém cạnh nam giới về chí khí và
  tham vọng
- Quản lý xuất sắc, tháo vát → quán xuyến tốt cả gia đình lẫn công việc
- Hội cát tinh → **nữ lãnh đạo, doanh nhân thành đạt**, hình mẫu **"phụ nữ nắm
  quyền đàn ông"**

⚠️ Tính mạnh mẽ + khao khát kiểm soát + Phá Quân xung chiếu → dễ **áp đặt bạn
đời** → khuyên **kết hôn muộn** hoặc lấy người **lớn tuổi, trưởng thành, bao dung**.

## Nam mệnh Tử Tướng

- **Uy nghi, tự tôn cao**, tài năng tổ chức, mưu lược
- Nhạy bén với **chính trị, quản lý doanh nghiệp, hành chính công**

⚠️ Áp lực Thiên La - Địa Võng → con đường tiến thân **hiếm khi bằng phẳng**,
đầy cạnh tranh thử thách. Thiếu phò tá → **"cô quân"** bảo thủ, độc đoán. Tổ
hợp Tử Tướng + Phá Quân khi quyết định lớn dễ **"bạc bẽo, lục thân bất nhận"**
→ thành tựu lớn nhưng dễ mất các mối quan hệ thân tình.`,
  },
  ...
  // ============================================================
  {
    ...
    title: 'Tử Phá đồng cung cư Mệnh tại Sửu / Mùi',
    sao: ['Tử Vi', 'Phá Quân'],
    cung: ['Mệnh'],
    chi: ['Sửu', 'Mùi'],
...
⚠️ Phá Quân Thủy bị Tử Vi Thổ kiểm soát → mâu thuẫn về lý tưởng không phải vấn
...
- **Nữ mệnh:** dễ rơi vào cách **cao số, kén chồng**, hoặc do thiên về quyền lực
  → **át chồng** → thường **lấy chồng muộn**
- **Nam mệnh:** lý tưởng và tầm mắt cao → cũng **lấy vợ muộn**, thường khi sự
  nghiệp đạt thành tựu nhất định mới nghĩ chuyện kết hôn

## Hội cát tinh

**+ Tả Hữu / Khôi Việt / Hóa Khoa / Hóa Quyền:** Phá Quân **mềm tính hơn**,
bớt xung đột.

**+ Hóa Lộc:** đắc cách thành tựu lớn — **làm đến đâu có thành tựu đến đó**,
ngày càng tăng trưởng.

⚠️ **KHÔNG nên đi cùng Văn Xương / Văn Khúc** — làm giảm sự liều lĩnh và quyết
đoán.

## Hội hung sát tinh

⚠️ **+ Kình Dương / Hỏa Tinh:** dễ phá cách → cuộc đời nhiều chìm nổi, khó quy
tụ lực lượng.

⚠️ **+ Đà La / Linh Tinh:** thành **cứng đầu**, khó tiếp thu cái tốt.

⚠️ **+ Không Kiếp:** phá cách → tư tưởng **lệch lạc, lập dị**.
...
- ⚠️ **Khó có công danh với đời** dù làm ăn được`,
  },
  ...
  // ============================================================
  {
    ...
    title: 'Tử Tham đồng cung cư Mệnh tại Mão / Dậu - "Đào Hoa Phạm Chủ"',
    sao: ['Tử Vi', 'Tham Lang'],
    cung: ['Mệnh'],
    chi: ['Mão', 'Dậu'],
...
⚠️ Cổ nhân cho rằng "nặng dục vọng" — nhưng chỉ rơi vào nhục dục khi **PHÁ CÁCH**
...
- Cách cục **làm việc lớn**, tham vọng + tầm nhìn → **dễ thành lãnh đạo**
- ⚠️ Vất vả hơn nam — sự lả lướt đào hoa làm lu mờ tôn nghiêm Tử Vi → **dễ thị
  phi, hiểu lầm**

## Hội cát tinh

**+ Tả Phụ / Thiên Khôi:** giảm đào hoa, **TĂNG chính khí Tử Vi** — đặc biệt
cần Tả Phụ hoặc Thiên Khôi.

**+ Hữu Bật / Thiên Việt:** cần tránh các sát tinh khác vì dễ thúc đẩy đào hoa.

⚠️ **KHÔNG nên đi cùng Văn Xương / Văn Khúc** — dễ phá cách, giảm năng lực lãnh
đạo, **thiên về làm chuyên môn** hơn là đứng đầu tổ chức.

## Hội hung sát tinh

⚠️ **+ Đà La / Linh Tinh:** kích phát **đam mê tửu sắc** → Tử Vi mất chính khí.

⚡ **+ Kình Dương / Hỏa Tinh:** **CHẾ PHÁT** — hưởng đặc tính tốt, có **uy quyền**,
khó tránh vọng động vất vả nhưng **thành tựu lớn hơn**.

⚠️ **+ Không Kiếp:** biến tướng tham vọng, **bất đắc chí** — dễ tha hóa nếu làm
ngành biến động. Đến trung niên dễ **chọn tu tập, tâm linh** vì bất đắc chí.
...
trạng thái **Bình Hòa** → không phát huy hết sức mạnh, **dễ bị Tham Lang chi phối**.`,
  ...
  // ============================================================
  {
    ...
    title: 'Tử Sát đồng cung cư Mệnh tại Tỵ / Hợi',
    sao: ['Tử Vi', 'Thất Sát'],
    cung: ['Mệnh'],
    chi: ['Tỵ', 'Hợi'],
...
Ở cung **Quan Lộc** là vị trí đắc vị nhất — tính chất **"Hóa Sát thành Quyền"**
thể hiện rõ rệt: đương số có **quyền hành lớn**, đảm nhận vị trí quan trọng,
phù hợp **chỉ huy quân đội / cảnh sát / giám đốc điều hành**.
...
⚠️ **+ Kình Đà / Thiên Hình:** quyền lực bị **lạm dụng** → độc đoán, tàn bạo,
liều lĩnh, **xung đột bạo lực, tranh chấp pháp lý**.

⚠️ **+ Hỏa Linh:** nóng nảy bộc phát → quyết định **vội vàng** → thất bại, sự
nghiệp bất ổn.

⚠️ **+ Không Kiếp:** bất ổn biến động — dễ **sụp đổ đột ngột, phá sản**.

⚠️ **+ Tuần / Triệt:** có tài nhưng **không cơ hội thể hiện**, gò bó bất mãn,
"có danh không có quyền".`,
  },
...
Thêm **Tả Phụ + Hữu Bật** hoặc chỉ cần **Khôi Việt** → công danh địa vị, **thành
...
⚠️ **Tử Vi cư Ngọ + Tuần / Triệt** = cách **"Đới Ấn Triều Hồi"** — **MẤT đường
...
⚠️ Tử Vi đơn thủ → **CẦN Tả Hữu Khôi Việt** trong tam phương để tránh rơi vào
**"Cô Quân"**.`,
  },
...
⚠️ Sự nổi bật dễ kéo theo **đố kỵ, ganh ghét** → cần tỉnh táo và khéo léo trong
quan hệ xã hội.`,
  },
...
⚠️ **Khuyết điểm:** kết hợp **Vũ Khúc Hóa Kỵ ở Tài Bạch** → **không nên tự bỏ
vốn kinh doanh**, nên dùng quyền lực và trí tuệ để **quản lý điều hành tổ chức**.`,
  },
...
- **+ Tả Hữu / Khôi Việt / Hóa Quyền / Ấn Cáo:** phúc dày, cha mẹ có **tiếng nói,
  danh chức** trong tổ chức / xã hội — đương số được giúp đỡ, định hướng từ cha mẹ
- ⚠️ **+ Tham Lang / Phá Quân / Không Kiếp / Kình Đà:** **phúc ấm giảm**, cha mẹ
  dễ **chia ly hoặc kiện cáo hôn nhân**`,
  },
...
- **+ Thiên Phủ / Thiên Tướng / Thất Sát:** trong họ có người **thành danh phương xa**
- **+ Tả Hữu + cát tinh:** phúc khí dày, **gia tộc bề thế**
- ⚠️ **+ Tham/Phá/Không Kiếp/Kình Đà:** phúc suy giảm, **họ hàng ly tán**, có người vướng **lao lý**
- ⚠️ Khuyết: **ham muốn quyền lực**, theo đuổi xa vời, thiếu thực tế`,
  },
...
- **+ Văn Xương / Văn Khúc / Tả Hữu:** gia trạch gọn gàng
- **+ Cát tinh nhiều:** dễ thêm nhà cửa, **tích lũy bất động sản giá trị**
- ⚠️ **+ Thất Sát / Phá Quân / Tham Lang:** điền sản **dễ tiêu tán**, nhà cửa
  thay đổi liên miên, khó an cư`,
  },
...
- **+ Thất Sát:** hợp **nghề võ, tài chính, kiểm sát**
- **+ Thiên Tướng:** giỏi **quản lý tài chính**, có tố chất lãnh đạo (hơi độc đoán)
- ⚠️ **+ Thiên Hình / Thiên Riêu / Hóa Kỵ:** dễ sa **cờ bạc, đỏ đen**
- ⚠️ **+ Phá Quân / Tham Lang / Không Kiếp:** công danh **trắc trở, vướng tai họa**
  trong công việc — nếu có cát tinh hỗ trợ vẫn thành công nhưng phải **trải đắng
  cay rồi mới hưởng mật ngọt**`,
  },
  ...
  {
    id: 'tu-vi-tai-no-boc',
    title: 'Tử Vi tại Nô Bộc',
    sao: ['Tử Vi'],
    cung: ['Nô Bộc'],
    doUuTien: 78,
    tomTat: `**Tử Vi tại Nô Bộc:**

- **+ Thai / Bát Tọa / Hồng Loan / Thiên Hỷ / Hỷ Thần:** nhiều **bạn bè quyền
  quý, cấp dưới trung thành**. ⚠️ Khó tránh tất tả ngược xuôi vì lo cho người khác
- ⚠️ **+ Hóa Kỵ / Không Kiếp / Tuần án ngữ:** cẩn trọng **bạn xấu**, kéo bè kết
  cánh, **bị lợi dụng**, dính vào thị phi`,
  },
...
- **+ Khôi Việt / Long Trì / Phượng Các:** rất tốt
- ⚠️ **+ Tham Lang / Phá Quân + Không Kiếp / Hóa Kỵ / sát tinh:** rơi vào thế
  **"Đế Ngộ Hung Đồ"** (vua gặp đường hung) → dễ **bị lừa gạt**, dính kiện tụng,
  bị **qua cầu rút ván**`,
  },
...
**+ Khôi Việt + cát tinh:** lúc lâm chung được **nhiều người thương tiếc, phúng
viếng trọng thể**, có cả **quan chức, người quyền quý** đến đưa tiễn.`,
  },
...
- **+ Thiên Phủ** hoặc **cư Ngọ + Lộc Tồn / Hóa Lộc:** dễ giàu, **làm ít hưởng nhiều**
- ⚠️ **+ Tham Lang / Phá Quân / Tuần / Triệt:** tài lộc khó bền, dễ **tiêu tan,
  hao tài**, bị kẻ khác **lợi dụng** — bộ Sát Phá Tham gặp Tử Vi sẽ **khắc chế
  tính cát lành**`,
  },
...
- **+ Thiên Phủ / Thiên Tướng / Thất Sát / Tả Hữu / Hóa Lộc:** đông con, **hiếu
  thuận**, cha mẹ **nở mày nở mặt**
- ⚠️ **+ Tham Lang / Phá Quân:** dấu hiệu **muộn con, ít con** hoặc **cha mẹ -
  con cái thiếu hòa thuận**
- ⚠️ Khuyết: con **kỹ tính, cầu toàn, ít bộc lộ tình cảm, kiêu ngạo**`,
  },
  ...
  // ============================================================
  {
    ...
    cung: ['Phu Thê'],
    doUuTien: 82,
    tomTat: `**Tử Vi tại Phu Thê:** người bạn đời có **khí chất, vị trí xã hội cao**.
Hôn nhân thường gặp người **hơn tuổi** hoặc ở vị trí cao hơn.

- **Đứng một mình hoặc + Thiên Phủ / Xương Khúc / Tả Hữu:** hôn nhân **bền chặt**,
  vợ chồng **đùm bọc lẫn nhau**, gia đình bên hôn phối thuộc **danh giá**:
  - **Nam:** lấy được **vợ giỏi giang**
  - **Nữ:** lấy **chồng sang giàu**
- ⚠️ **+ sát tinh / Tham Lang / Phá Quân:** vợ chồng **bất hòa**, "cơm chẳng lành
  canh chẳng ngọt", có thể **2 lần đò**`,
...
- ⚠️ Bản thân thường ở **địa vị dưới**, làm **người hỗ trợ**
- ⚠️ **+ Phá Quân:** dễ có **anh em dị bào** (khác mẹ), tình cảm trên dưới thiếu hòa hợp
- ⚠️ **+ Tham Lang + sát tinh:** trong nhà có **anh em ngỗ nghịch**, thói côn đồ,
  hoặc **chết trẻ, yểu mệnh**`,
  },
...
Cách này áp dụng đặc biệt cho **Tử Tướng Thìn/Tuất** — khi ôm vòng Thái Tuế thì
...
⚠️ **Đại vận Tử Sát đồng cung:** bán cát bán hung — nhưng vẫn may mắn cho công danh.`,

    chiTiet: `## Hạn đến Tử Vi

Tử Vi không có hãm địa → đại tiểu hạn gặp Tử Vi tại **miếu / vượng / đắc địa**
hoặc đồng cung **Thiên Phủ / Thiên Tướng / Tả Hữu / Khoa Quyền Lộc** → **rất tốt**,
danh tài đều lợi, may mắn toàn diện.

**+ Khôi Việt:** thắng lợi về mọi mặt.

## Hạn xấu

- **Vị trí bình hòa (Tý, Hợi, Mão, Dậu):** kém tốt, bình thường — gặp bất lợi
  thì khó qua
- ⚠️ **Tuần / Triệt ở cả hai hạn:** **tính mạng lâm nguy**
- **+ Sát tinh** (Không, Kiếp, Kỵ, Thiên Hình): đau ốm, mất của, kiện tụng
- **+ Kình Đà Kỵ:** đau ốm, mắc lừa
