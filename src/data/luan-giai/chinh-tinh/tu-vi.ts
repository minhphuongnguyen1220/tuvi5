...
đâu có thành tựu đến đó**, ngày càng tăng trưởng.`,
...

  {
    ...
    doUuTien: 87,
    tomTat: `⚠️ **Tử Phá Sửu/Mùi + Kình Dương / Hỏa Tinh:** dễ phá cách → cuộc đời
nhiều chìm nổi, khó quy tụ lực lượng.`,
...

  {
    ...
    doUuTien: 87,
    tomTat: `⚠️ **Tử Phá Sửu/Mùi + Đà La / Linh Tinh:** thành **cứng đầu**, khó
tiếp thu cái tốt.`,
  },

  {
    ...
    doUuTien: 87,
    tomTat: `⚠️ **Tử Phá Sửu/Mùi + Địa Không / Địa Kiếp:** phá cách → tư tưởng
**lệch lạc, lập dị**.`,
  },
...
khác vì dễ thúc đẩy đào hoa.`,
...

  {
    ...
    ketHop: ['Đà La', 'Linh Tinh'],
    doUuTien: 87,
    tomTat: `⚠️ **Tử Tham Mão/Dậu + Đà La / Linh Tinh:** kích phát **đam mê tửu
...
hơn**.`,
...

  {
    ...
    ketHop: ['Địa Không', 'Địa Kiếp'],
    doUuTien: 87,
    tomTat: `⚠️ **Tử Tham Mão/Dậu + Địa Không / Địa Kiếp:** biến tướng tham vọng,
...
- **Hóa Quyền:** củng cố và **gia tăng quyền lực** — cần hài hòa, tránh lạm dụng`,
...

  {
    ...
    doUuTien: 87,
    tomTat: `⚠️ **Tử Sát Tỵ/Hợi + Kình Đà / Thiên Hình:** quyền lực bị **lạm dụng**
→ độc đoán, tàn bạo, liều lĩnh, **xung đột bạo lực, tranh chấp pháp lý**.`,
...

  {
    ...
    doUuTien: 87,
    tomTat: `⚠️ **Tử Sát Tỵ/Hợi + Hỏa Tinh / Linh Tinh:** nóng nảy bộc phát →
quyết định **vội vàng** → thất bại, sự nghiệp bất ổn.`,
...

  {
    ...
    ketHop: ['Địa Không', 'Địa Kiếp'],
    doUuTien: 87,
    tomTat: `⚠️ **Tử Sát Tỵ/Hợi + Địa Không / Địa Kiếp:** bất ổn biến động — dễ
**sụp đổ đột ngột, phá sản**.`,
...

  {
    ...
    ketHop: ['Tuần', 'Triệt'],
    doUuTien: 87,
    tomTat: `⚠️ **Tử Sát Tỵ/Hợi + Tuần / Triệt:** có tài nhưng **không cơ hội thể
...
đương số được giúp đỡ, định hướng từ cha mẹ.`,
...

  {
    ...
    doUuTien: 75,
    tomTat: `⚠️ **Tử Vi + Tham Lang / Phá Quân / Không Kiếp / Kình Đà tại Phụ Mẫu:**
...
**gia tộc bề thế**.`,
...

  {
    ...
    ketHop: ['Tham Lang', 'Phá Quân', 'Địa Không', 'Địa Kiếp', 'Kình Dương', 'Đà La'],
    doUuTien: 75,
    tomTat: `⚠️ **Tử Vi + Tham Lang / Phá Quân / Không Kiếp / Kình Đà tại Phúc Đức:**
...
lũy bất động sản giá trị**.`,
...

  {
    ...
    doUuTien: 75,
    tomTat: `⚠️ **Tử Vi + Thất Sát / Phá Quân / Tham Lang tại Điền Trạch:** điền
...
có tố chất lãnh đạo (hơi độc đoán).`,
...

  {
    ...
    doUuTien: 83,
    tomTat: `⚠️ **Tử Vi + Thiên Hình / Thiên Riêu / Hóa Kỵ tại Quan Lộc:** dễ sa
**cờ bạc, đỏ đen**.`,
  },

  {
    ...
    doUuTien: 83,
    tomTat: `⚠️ **Tử Vi + Phá Quân / Tham Lang / Địa Không / Địa Kiếp tại Quan
...
Bộc:** nhiều **bạn bè quyền quý, cấp dưới trung thành**. ⚠️ Khó tránh tất tả
ngược xuôi vì lo cho người khác.`,
...

  {
    ...
    doUuTien: 73,
    tomTat: `⚠️ **Tử Vi + Hóa Kỵ / Địa Không / Địa Kiếp / Tuần án ngữ tại Nô Bộc:**
...
tốt — ra ngoài may mắn, được quý nhân hỗ trợ.`,
...

  {
    ...
    doUuTien: 75,
    tomTat: `⚠️ **Tử Vi + Tham Lang / Phá Quân + Không Kiếp / Hóa Kỵ / sát tinh tại
...
việc thuận buồm xuôi gió → **hiếm khi rơi vào cảnh thiếu thốn**.`,
...

  {
    ...
    title: 'Tử Vi + Thiên Phủ hoặc cư Ngọ + Lộc Tồn / Hóa Lộc tại Tài Bạch',
    sao: ['Tử Vi'],
    cung: ['Tài Bạch'],
    ketHop: ['Thiên Phủ', 'Lộc Tồn', 'Hóa Lộc'],
    doUuTien: 80,
    tomTat: `✅ **Tử Vi + Thiên Phủ** hoặc **cư Ngọ + Lộc Tồn / Hóa Lộc tại Tài
Bạch:** dễ giàu, **làm ít hưởng nhiều**.`,
  },

  {
    ...
    doUuTien: 80,
    tomTat: `⚠️ **Tử Vi + Tham Lang / Phá Quân / Tuần / Triệt tại Tài Bạch:** tài
...
tại Tử Tức:** đông con, **hiếu thuận**, cha mẹ **nở mày nở mặt**.`,
...

  {
    ...
    doUuTien: 75,
    tomTat: `⚠️ **Tử Vi + Tham Lang / Phá Quân tại Tử Tức:** dấu hiệu **muộn con,
...
- ⚠️ Bản thân thường ở **địa vị dưới**, làm **người hỗ trợ**`,
...

  {
    ...
    ketHop: ['Phá Quân'],
    doUuTien: 73,
    tomTat: `⚠️ **Tử Vi + Phá Quân tại Huynh Đệ:** dễ có **anh em dị bào** (khác
mẹ), tình cảm trên dưới thiếu hòa hợp.`,
...

  {
    ...
    doUuTien: 73,
    tomTat: `⚠️ **Tử Vi + Tham Lang + sát tinh tại Huynh Đệ:** trong nhà có **anh
...
**dưới trướng một ông chủ rất giỏi, tốt bụng, có tài quản lý**, tài lộc hưng vượng.`,
...

  {
    ...
    doUuTien: 45,
    tomTat: `⚠️ **Đại vận / hạn Tử Vi + Sát tinh** (Không, Kiếp, Kỵ, Thiên Hình):
**đau ốm, mất của, kiện tụng**.`,
...

  {
    ...
    doUuTien: 45,
    tomTat: `⚠️ **Đại vận / hạn Tử Vi + Kình Dương / Đà La / Hóa Kỵ:** **đau ốm,
mắc lừa**.`,
  },
];
