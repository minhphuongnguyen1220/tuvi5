...
Có nét **thông minh, có chí hướng, dễ gặp quý nhân nâng đỡ**. Xem entry chuyên
biệt cho Nam / Nữ mệnh.`,
  },
...
nền nã**, biết lo toan, hợp hình mẫu **"vợ hiền mẹ đảm"**.`,
  ...
  // ============================================================
  {
    ...
    cung: ['Mệnh'],
    doUuTien: 50,
    tomTat: `**Tính cách Tử Vi cư Mệnh thay đổi theo vị trí (Miếu / Vượng / Đắc /
Bình)** — xem entry chuyên biệt theo trạng thái và chi.`,
...
Hôn nhân thường gặp người **hơn tuổi** hoặc ở vị trí cao hơn. Xem entry chuyên
biệt cho Nam / Nữ mệnh và bộ kết hợp cụ thể.`,
...
giá**.`,
...

  {
    ...
    doUuTien: 78,
    tomTat: `⚠️ **Tử Vi + sát tinh / Tham Lang / Phá Quân tại Phu Thê:** vợ chồng
