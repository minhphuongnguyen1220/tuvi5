...
hay tranh cãi. Xem thêm entry chuyên biệt theo trạng thái và chi.`,
    chiTiet: `## Cát kết hợp
...
bệnh dạ dày, phổi, mụn nhọt, ung thư và các chứng âm tồn. Xem entry chuyên
...
hào sảng, thông minh, dũng cảm — đặc biệt khi có Thái Dương đồng cung. Xem
entry chuyên biệt cho Nữ mệnh.`,
...
Xem entry chuyên biệt cho Nữ mệnh khi gặp Hóa Quyền, Hóa Lộc, Lộc Tồn, Tả
Phù hay Hữu Bật.
...
Khi hội cùng Kình Dương, Đà La, Hỏa Tinh, Linh Tinh hay Thiên Hình, xem
entry chuyên biệt cho Nữ mệnh ba đời chồng.`,
  },
