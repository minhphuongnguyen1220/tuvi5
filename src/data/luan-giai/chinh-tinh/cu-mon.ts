...
**Sao Cự Môn không nên xuất hiện trong Mệnh nữ giới** — câu "ngôn đa tất thất"
...
Nếu gặp Hóa Kỵ hoặc sát tinh: sản nghiệp dễ bị lừa đảo, vướng kiện tụng,
...
lực, **về già có thể tốt**.`,
...

  {
    ...
    trangThai: ['Hãm'],
    doUuTien: 78,
    tomTat: `**Cự Môn HÃM tại Nô Bộc (Thìn / Tuất):** công việc lộn xộn, dễ
...
Hay bị đố kỵ, ganh ghét, gặp thị phi do tính đa nghi.`,
...
không tốt**.`,
...

  {
    ...
    trangThai: ['Hãm'],
    doUuTien: 78,
    tomTat: `**Cự Môn HÃM tại Tật Ách:** dễ bị **tật mủ máu, bệnh thận, dạ
dày, phổi, ung thư**.`,
  },
...
có sự nghiệp lớn.`,
...

  {
    ...
    doUuTien: 78,
    tomTat: `**Nữ mệnh — Cự Môn tại Phu Thê + Kình / Đà / Hỏa / Linh / Thiên
...
giả**. Có **Tả Phù + Hữu Bật**: rủi ro giảm dù có Hóa Kỵ đồng cung.`,
...

  {
    ...
    doUuTien: 50,
    tomTat: `**Cự hãm + Kình Đà:** yếu đuối, thiếu sức sống, hay **mắc bệnh
...
con gái thì **lăng loàn, tai tiếng**.`,
...

  {
    ...
    doUuTien: 50,
    tomTat: `**Cự + Linh + Hỏa:** cách rất xấu, hạn nặng: **chết yểu** hoặc
tai nạn lớn khó qua khỏi.`,
...

  {
    ...
    doUuTien: 45,
    tomTat: `**Cự + Đà + Kình:** gặp biến cố tâm lý, trầm cảm u uất: **tự
vẫn**. Không thì bị **tàn tật, chân tay bỏng nặng**.`,
...

  {
    ...
    ketHop: ['Lộc Tồn'],
    doUuTien: 50,
    tomTat: `**Cự tại Tý / Ngọ + Lộc Tồn đồng cung:** có tài nhưng **không
gặp thời**.`,
  },

  {
    ...
    ketHop: ['Lộc Tồn'],
    doUuTien: 50,
    tomTat: `**Cự tại Hợi / Tý + Lộc Tồn đồng cung:** tham vọng lớn nhưng
**không hiện thực hóa được**, tài năng không được khai phá.`,
...

  {
    ...
    doUuTien: 50,
    tomTat: `**Cự + Tham + Riêu** hoặc **Cự + Tham + Hao:** chủ hạn tại gia
— **thất nghiệp, tù tội, hay gặp nạn**.`,
...

  {
    ...
    ketHop: ['Hóa Kỵ'],
    doUuTien: 78,
    tomTat: `**Nữ mệnh — Cự Môn + Hóa Kỵ tại Mệnh:** đàn bà thì **thất tiết**,
